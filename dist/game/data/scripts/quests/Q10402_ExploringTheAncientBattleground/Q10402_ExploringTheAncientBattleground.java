 ...
 */
package quests.Q10402_ExploringTheAncientBattleground;
 ...
 * @author nnlyy520
 */
public class Q10402_ExploringTheAncientBattleground extends Quest
{
	private static final int QUEST_ID = 10402;
	private static final int[] MONSTERS =
	{
		22676, // Knight of the Past
		22677, // Ghostly Warrior
		22678, // Nihil Invader
	};
	
	public Q10402_ExploringTheAncientBattleground()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10403_ExploringTheEnchantedValley.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10403, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
