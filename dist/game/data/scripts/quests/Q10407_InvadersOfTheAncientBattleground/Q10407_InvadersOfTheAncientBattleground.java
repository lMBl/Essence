 ...
 */
package quests.Q10407_InvadersOfTheAncientBattleground;
 ...
 * @author nnlyy520
 */
public class Q10407_InvadersOfTheAncientBattleground extends Quest
{
	private static final int QUEST_ID = 10407;
	private static final int[] MONSTERS =
	{
		22679 // Bloody Priest
	};
	
	public Q10407_InvadersOfTheAncientBattleground()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10408_InvadersOfTheEnchantedValley.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10408, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
