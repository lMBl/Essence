 ...
 */
package quests.Q10082_EfficientTraining;
 ...
 * @author Magik
 */
public class Q10082_EfficientTraining extends Quest
{
	private static final int QUEST_ID = 10082;
	
	public Q10082_EfficientTraining()
	{
		super(QUEST_ID);
	}
		...
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				if (questState.isCond(QuestCondType.DONE) && !questState.isCompleted())
				{
					...
					final QuestState nextQuestState = player.getQuestState(Q10083_NewLifesLessons.class.getSimpleName());
					if (nextQuestState == null)
					{
						player.sendPacket(new ExQuestDialog(10083, QuestDialogType.ACCEPT));
					}
				}
				break;
			}
	...
	public void onPlayerLogin(OnPlayerLogin event)
	{
		...
		if ((questState == null) || !questState.isCompleted())
		{
			player.sendPacket(new PlaySound(2, "tutorial_voice_053a", 0, 0, player.getX(), player.getY(), player.getZ()));
		}
	}
}
