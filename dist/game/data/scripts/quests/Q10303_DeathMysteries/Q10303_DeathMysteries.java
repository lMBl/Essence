 ...
 */
package quests.Q10303_DeathMysteries;
 ...
 * @author Magik
 */
public class Q10303_DeathMysteries extends Quest
{
	...
	private static final int[] MONSTERS =
	{
		...
		20551, // Road Scavanger
		20552, // Fettered Soul
		20553, // Windus
		20554, // Grandis
	};
	
	public Q10303_DeathMysteries()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10304_ANewLook.class.getSimpleName());
