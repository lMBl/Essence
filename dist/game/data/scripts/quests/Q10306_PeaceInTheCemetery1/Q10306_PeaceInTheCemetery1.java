 ...
 */
package quests.Q10306_PeaceInTheCemetery1;
 ...
 * @author Magik
 */
public class Q10306_PeaceInTheCemetery1 extends Quest
{
	...
	public Q10306_PeaceInTheCemetery1()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10307_PeaceInTheCemetery2.class.getSimpleName());
