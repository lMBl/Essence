 ...
 */
package quests.Q10010_TimeToChangeClass;
 ...
 * @author Magik
 */
public class Q10010_TimeToChangeClass extends Quest
{
	...
	public Q10010_TimeToChangeClass()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10011_GoingOut.class.getSimpleName());
	...
	public void onPlayerProfessionChange(OnPlayerProfessionChange event)
	{
		...
		final QuestState questState = getQuestState(player, false);
		if ((questState != null) && !questState.isCompleted() && (player.getClassId().getId() > ClassId.FIGHTER.getId()))
		{
