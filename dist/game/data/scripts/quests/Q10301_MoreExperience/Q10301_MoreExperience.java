 ...
 */
package quests.Q10301_MoreExperience;
 ...
 * @author Magik
 */
public class Q10301_MoreExperience extends Quest
{
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10302_SecretGarden.class.getSimpleName());
