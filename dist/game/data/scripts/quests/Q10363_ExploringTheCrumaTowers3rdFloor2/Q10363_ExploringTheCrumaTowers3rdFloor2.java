 ...
 */
package quests.Q10363_ExploringTheCrumaTowers3rdFloor2;
 ...
 * @author Magik
 */
public class Q10363_ExploringTheCrumaTowers3rdFloor2 extends Quest
{
	private static final int QUEST_ID = 10363;
	...
	public Q10363_ExploringTheCrumaTowers3rdFloor2()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10364_ExploringTheCrumaTowers3rdFloor3.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10364, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
