 ...
 */
package quests.Q10083_NewLifesLessons;
 ...
 * @author Magik
 */
public class Q10083_NewLifesLessons extends Quest
{
	private static final int QUEST_ID = 10083;
		...
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				if (questState.isCond(QuestCondType.DONE) && !questState.isCompleted())
				{
					...
					final QuestState nextQuestState = player.getQuestState(Q10084_StrengthOfSpirit.class.getSimpleName());
					if (nextQuestState == null)
					{
						player.sendPacket(new ExQuestDialog(10084, QuestDialogType.ACCEPT));
					}
				}
				break;
			}
