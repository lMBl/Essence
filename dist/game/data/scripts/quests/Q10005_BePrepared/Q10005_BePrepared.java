 ...
 */
package quests.Q10005_BePrepared;
 ...
 * @author Magik, Mobius
 */
public class Q10005_BePrepared extends Quest
{
		...
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				if (questState.isCond(QuestCondType.DONE) && !questState.isCompleted())
				{
					...
					final QuestState nextQuestState = player.getQuestState(Q10006_UsefulPreparations.class.getSimpleName());
