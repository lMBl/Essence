 ...
 */
package quests.Q10053_BePrepared;
 ...
 * @author Magik
 */
public class Q10053_BePrepared extends Quest
{
	private static final int QUEST_ID = 10053;
		...
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				if (questState.isCond(QuestCondType.DONE) && !questState.isCompleted())
				{
					...
					final QuestState nextQuestState = player.getQuestState(Q10054_UsefulPreparations.class.getSimpleName());
					if (nextQuestState == null)
					{
						player.sendPacket(new ExQuestDialog(10054, QuestDialogType.ACCEPT));
					}
				}
				break;
			}
