 ...
 */
package quests.Q10064_BePrepared;
 ...
 * @author Magik
 */
public class Q10064_BePrepared extends Quest
{
	private static final int QUEST_ID = 10064;
		...
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				if (questState.isCond(QuestCondType.DONE) && !questState.isCompleted())
				{
					...
					final QuestState nextQuestState = player.getQuestState(Q10065_UsefulPreparations.class.getSimpleName());
					if (nextQuestState == null)
					{
						player.sendPacket(new ExQuestDialog(10065, QuestDialogType.ACCEPT));
					}
				}
				break;
			}
