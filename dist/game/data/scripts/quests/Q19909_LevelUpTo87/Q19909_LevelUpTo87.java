 ...
 */
package quests.Q19909_LevelUpTo87;
 ...
 * @author Magik
 */
public class Q19909_LevelUpTo87 extends Quest
{
	private static final int QUEST_ID = 19909;
	
	public Q19909_LevelUpTo87()
	{
		super(QUEST_ID);
	}
	...
	public void onPlayerLevelChange(OnPlayerLevelChanged event)
	{
		...
		else if ((questState != null) && questState.isStarted() && !questState.isCompleted() && (player.getLevel() == 87))
		{
			questState.setCount(getQuestData().getGoal().getCount());
			questState.setCond(QuestCondType.DONE);
			player.sendPacket(new ExQuestNotification(questState));
