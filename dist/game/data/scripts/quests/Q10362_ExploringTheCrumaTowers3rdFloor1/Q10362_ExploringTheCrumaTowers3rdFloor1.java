 ...
 */
package quests.Q10362_ExploringTheCrumaTowers3rdFloor1;
 ...
 * @author Magik
 */
public class Q10362_ExploringTheCrumaTowers3rdFloor1 extends Quest
{
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10363_ExploringTheCrumaTowers3rdFloor2.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10363, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
