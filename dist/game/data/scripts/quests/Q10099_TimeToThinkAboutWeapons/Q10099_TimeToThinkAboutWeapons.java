 ...
 */
package quests.Q10099_TimeToThinkAboutWeapons;
 ...
 * @author Magik
 */
public class Q10099_TimeToThinkAboutWeapons extends Quest
{
	private static final int QUEST_ID = 10099;
	...
	public Q10099_TimeToThinkAboutWeapons()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10100_WatchOut.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10100, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
