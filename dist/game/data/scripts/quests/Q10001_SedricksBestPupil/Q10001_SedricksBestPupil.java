 ...
 */
package quests.Q10001_SedricksBestPupil;
 ...
 * @author Magik, Mobius
 */
public class Q10001_SedricksBestPupil extends Quest
{
	private static final int QUEST_ID = 10001;
	
	public Q10001_SedricksBestPupil()
	{
		super(QUEST_ID);
	}
		...
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				if (questState.isCond(QuestCondType.DONE) && !questState.isCompleted())
				{
					...
					final QuestState nextQuestState = player.getQuestState(Q10002_FightingSkill.class.getSimpleName());
	...
	public void onPlayerLogin(OnPlayerLogin event)
	{
		...
		if ((questState == null) || !questState.isCompleted())
		{
			player.sendPacket(new PlaySound(2, "tutorial_voice_001a_A", 0, 0, player.getX(), player.getY(), player.getZ()));
		}
	}
}
