 ...
 */
package quests.Q10086_BePrepared;
 ...
 * @author Magik
 */
public class Q10086_BePrepared extends Quest
{
	private static final int QUEST_ID = 10086;
		...
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				if (questState.isCond(QuestCondType.DONE) && !questState.isCompleted())
				{
					...
					final QuestState nextQuestState = player.getQuestState(Q10087_UsefulPreparations.class.getSimpleName());
					if (nextQuestState == null)
					{
						player.sendPacket(new ExQuestDialog(10087, QuestDialogType.ACCEPT));
					}
				}
				break;
			}
