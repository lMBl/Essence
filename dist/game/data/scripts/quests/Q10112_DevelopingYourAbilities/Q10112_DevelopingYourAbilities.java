 ...
 */
package quests.Q10112_DevelopingYourAbilities;
 ...
 * @author Magik
 */
public class Q10112_DevelopingYourAbilities extends Quest
{
	...
	public Q10112_DevelopingYourAbilities()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10113_TimeToChangeClass.class.getSimpleName());
