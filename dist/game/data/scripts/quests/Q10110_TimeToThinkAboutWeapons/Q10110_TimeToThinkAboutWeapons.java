 ...
 */
package quests.Q10110_TimeToThinkAboutWeapons;
 ...
 * @author Magik
 */
public class Q10110_TimeToThinkAboutWeapons extends Quest
{
	...
	public Q10110_TimeToThinkAboutWeapons()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10111_WatchOut.class.getSimpleName());
