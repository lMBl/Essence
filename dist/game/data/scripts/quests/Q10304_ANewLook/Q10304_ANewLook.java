 ...
 */
package quests.Q10304_ANewLook;
 ...
 * @author Magik
 */
public class Q10304_ANewLook extends Quest
{
	private static final int QUEST_ID = 10304;
	
	public Q10304_ANewLook()
	{
		super(QUEST_ID);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10305_SporeInfestedPlace.class.getSimpleName());
	...
	public void onPlayerProfessionChange(OnPlayerProfessionChange event)
	{
		...
		final QuestState questState = getQuestState(player, false);
		if ((questState != null) && !questState.isCompleted() && player.isInCategory(CategoryType.THIRD_CLASS_GROUP))
		{
