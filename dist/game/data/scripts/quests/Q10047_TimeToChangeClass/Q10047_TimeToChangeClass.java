 ...
 */
package quests.Q10047_TimeToChangeClass;
 ...
 * @author Magik
 */
public class Q10047_TimeToChangeClass extends Quest
{
	private static final int QUEST_ID = 10047;
	
	public Q10047_TimeToChangeClass()
	{
		super(QUEST_ID);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10048_BlessingOfAbyss.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10048, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
	...
	public void onPlayerProfessionChange(OnPlayerProfessionChange event)
	{
		...
		final QuestState questState = getQuestState(player, false);
		if ((questState != null) && ((!questState.isCompleted() && (player.getClassId().getId() > ClassId.DARK_FIGHTER.getId())) || (player.getClassId().getId() > ClassId.DARK_MAGE.getId())))
		{
