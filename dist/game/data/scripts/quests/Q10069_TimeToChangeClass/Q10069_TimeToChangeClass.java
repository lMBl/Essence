 ...
 */
package quests.Q10069_TimeToChangeClass;
 ...
 * @author Magik
 */
public class Q10069_TimeToChangeClass extends Quest
{
	private static final int QUEST_ID = 10069;
	
	public Q10069_TimeToChangeClass()
	{
		super(QUEST_ID);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10070_AmongTheBravestOfOrcs.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10070, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
	...
	public void onPlayerProfessionChange(OnPlayerProfessionChange event)
	{
		...
		final QuestState questState = getQuestState(player, false);
		if ((questState != null) && !questState.isCompleted() && (player.getClassId().getId() > ClassId.ORC_LANCER.getId()))
		{
