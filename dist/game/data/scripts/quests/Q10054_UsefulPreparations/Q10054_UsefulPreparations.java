 ...
 */
package quests.Q10054_UsefulPreparations;
 ...
 * @author Magik
 */
public class Q10054_UsefulPreparations extends Quest
{
	private static final int QUEST_ID = 10054;
	...
	public Q10054_UsefulPreparations()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
		...
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				if (questState.isCond(QuestCondType.DONE) && !questState.isCompleted())
				{
					...
					final QuestState nextQuestState = player.getQuestState(Q10055_TimeToThinkAboutWeapons.class.getSimpleName());
					if (nextQuestState == null)
					{
						player.sendPacket(new ExQuestDialog(10055, QuestDialogType.ACCEPT));
					}
				}
				break;
			}
