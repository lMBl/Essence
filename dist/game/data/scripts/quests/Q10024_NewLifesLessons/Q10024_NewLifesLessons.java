 ...
 */
package quests.Q10024_NewLifesLessons;
 ...
 * @author Magik
 */
public class Q10024_NewLifesLessons extends Quest
{
		...
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				if (questState.isCond(QuestCondType.DONE) && !questState.isCompleted())
				{
					...
					final QuestState nextQuestState = player.getQuestState(Q10026_StrengthOfSpirit.class.getSimpleName());
