 ...
 */
package quests.Q10098_UsefulPreparations;
 ...
 * @author Magik
 */
public class Q10098_UsefulPreparations extends Quest
{
	private static final int QUEST_ID = 10098;
	...
	public Q10098_UsefulPreparations()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
		...
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				if (questState.isCond(QuestCondType.DONE) && !questState.isCompleted())
				{
					...
					final QuestState nextQuestState = player.getQuestState(Q10099_TimeToThinkAboutWeapons.class.getSimpleName());
					if (nextQuestState == null)
					{
						player.sendPacket(new ExQuestDialog(10099, QuestDialogType.ACCEPT));
					}
				}
				break;
			}
