 ...
 */
package quests.Q10085_LearningAutoHunt;
 ...
 * @author Magik
 */
public class Q10085_LearningAutoHunt extends Quest
{
	private static final int QUEST_ID = 10085;
	...
	public Q10085_LearningAutoHunt()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
		...
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				if (questState.isCond(QuestCondType.DONE) && !questState.isCompleted())
				{
					...
					final QuestState nextQuestState = player.getQuestState(Q10086_BePrepared.class.getSimpleName());
					if (nextQuestState == null)
					{
						player.sendPacket(new ExQuestDialog(10086, QuestDialogType.ACCEPT));
					}
				}
				break;
			}
