 ...
 */
package quests.Q10104_SayhasChildren;
 ...
 * @author Magik
 */
public class Q10104_SayhasChildren extends Quest
{
	private static final int QUEST_ID = 10104;
	
	public Q10104_SayhasChildren()
	{
		super(QUEST_ID);
	}
		...
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				if (questState.isCond(QuestCondType.DONE) && !questState.isCompleted())
				{
					...
					final QuestState nextQuestState = player.getQuestState(Q10105_NewLifesLessons.class.getSimpleName());
	...
	public void onPlayerLogin(OnPlayerLogin event)
	{
		...
		if ((questState == null) || !questState.isCompleted())
		{
			player.sendPacket(new PlaySound(2, "tutorial_voice_059a", 0, 0, player.getX(), player.getY(), player.getZ()));
		}
	}
}
