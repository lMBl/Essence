 ...
 */
package quests.Q10302_SecretGarden;
 ...
 * @author Magik
 */
public class Q10302_SecretGarden extends Quest
{
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10303_DeathMysteries.class.getSimpleName());
