 ...
 */
package quests.Q10415_RumorsAboutGorde5;
 ...
 * @author nnlyy520
 */
public class Q10415_RumorsAboutGorde5 extends Quest
{
	private static final int QUEST_ID = 10415;
	...
	public Q10415_RumorsAboutGorde5()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10416_TaygaTheLeaderOfSelMahum1.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10416, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
