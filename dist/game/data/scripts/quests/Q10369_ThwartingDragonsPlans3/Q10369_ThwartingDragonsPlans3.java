 ...
 */
package quests.Q10369_ThwartingDragonsPlans3;
 ...
 * @author Magik
 */
public class Q10369_ThwartingDragonsPlans3 extends Quest
{
	private static final int QUEST_ID = 10369;
	...
	public Q10369_ThwartingDragonsPlans3()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10370_ThwartingDragonsPlans4.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10370, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
