 ...
 */
package quests.Q10058_TimeToChangeClass;
 ...
 * @author Magik
 */
public class Q10058_TimeToChangeClass extends Quest
{
	private static final int QUEST_ID = 10058;
	
	public Q10058_TimeToChangeClass()
	{
		super(QUEST_ID);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10059_AmongTheBravestOfOrcs.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10059, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
	...
	public void onPlayerProfessionChange(OnPlayerProfessionChange event)
	{
		...
		final QuestState questState = getQuestState(player, false);
		if ((questState != null) && ((!questState.isCompleted() && (player.getClassId().getId() > ClassId.ORC_FIGHTER.getId())) || (player.getClassId().getId() > ClassId.ORC_MAGE.getId())))
		{
