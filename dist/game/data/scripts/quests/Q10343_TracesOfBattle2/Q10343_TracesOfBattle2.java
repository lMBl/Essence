 ...
 */
package quests.Q10343_TracesOfBattle2;
 ...
 * @author Magik
 */
public class Q10343_TracesOfBattle2 extends Quest
{
	private static final int QUEST_ID = 10343;
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10344_TracesOfBattle3.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10344, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
