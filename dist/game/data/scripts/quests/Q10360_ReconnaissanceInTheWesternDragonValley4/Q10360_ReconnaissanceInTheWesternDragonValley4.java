 ...
 */
package quests.Q10360_ReconnaissanceInTheWesternDragonValley4;
 ...
 * @author Magik
 */
public class Q10360_ReconnaissanceInTheWesternDragonValley4 extends Quest
{
	private static final int QUEST_ID = 10360;
	...
	public Q10360_ReconnaissanceInTheWesternDragonValley4()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10361_ReconnaissanceInTheWesternDragonValley5.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10361, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
