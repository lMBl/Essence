 ...
 */
package quests.Q10371_ThwartingDragonsPlans5;
 ...
 * @author Magik
 */
public class Q10371_ThwartingDragonsPlans5 extends Quest
{
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10372_ExploringTheCrumaTowers2ndFloor1.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10372, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
