 ...
 */
package quests.Q10041_LearningAutoHunt;
 ...
 * @author Magik
 */
public class Q10041_LearningAutoHunt extends Quest
{
	private static final int QUEST_ID = 10041;
	...
	public Q10041_LearningAutoHunt()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
		...
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				if (questState.isCond(QuestCondType.DONE) && !questState.isCompleted())
				{
					...
					final QuestState nextQuestState = player.getQuestState(Q10042_BePrepared.class.getSimpleName());
					if (nextQuestState == null)
					{
						player.sendPacket(new ExQuestDialog(10042, QuestDialogType.ACCEPT));
					}
				}
				break;
			}
