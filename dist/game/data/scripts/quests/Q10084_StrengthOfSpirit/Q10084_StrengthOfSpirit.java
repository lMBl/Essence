 ...
 */
package quests.Q10084_StrengthOfSpirit;
 ...
 * @author Magik
 */
public class Q10084_StrengthOfSpirit extends Quest
{
	private static final int QUEST_ID = 10084;
	...
	public Q10084_StrengthOfSpirit()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
		...
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				if (questState.isCond(QuestCondType.DONE) && !questState.isCompleted())
				{
					...
					final QuestState nextQuestState = player.getQuestState(Q10085_LearningAutoHunt.class.getSimpleName());
					if (nextQuestState == null)
					{
						player.sendPacket(new ExQuestDialog(10085, QuestDialogType.ACCEPT));
					}
				}
				break;
			}
