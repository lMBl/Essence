 ...
 */
package quests.Q10411_RumorsAboutGorde1;
 ...
 * @author nnlyy520
 */
public class Q10411_RumorsAboutGorde1 extends Quest
{
	private static final int QUEST_ID = 10411;
	...
	public Q10411_RumorsAboutGorde1()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				{
					player.sendPacket(new ExQuestDialog(10412, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
