 ...
 */
package quests.Q10353_StopTheLizardmen2;
 ...
 * @author Magik
 */
public class Q10353_StopTheLizardmen2 extends Quest
{
	private static final int QUEST_ID = 10353;
	...
	public Q10353_StopTheLizardmen2()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10354_StopTheLizardmen3.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10354, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
