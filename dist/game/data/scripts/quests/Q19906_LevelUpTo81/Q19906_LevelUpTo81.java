 ...
 */
package quests.Q19906_LevelUpTo81;
 ...
 * @author Magik
 */
public class Q19906_LevelUpTo81 extends Quest
{
	private static final int QUEST_ID = 19906;
	
	public Q19906_LevelUpTo81()
	{
		super(QUEST_ID);
	}
	...
	public void onPlayerLevelChange(OnPlayerLevelChanged event)
	{
		...
		else if ((questState != null) && questState.isStarted() && !questState.isCompleted() && (player.getLevel() == 81))
		{
			questState.setCount(getQuestData().getGoal().getCount());
			questState.setCond(QuestCondType.DONE);
			player.sendPacket(new ExQuestNotification(questState));
