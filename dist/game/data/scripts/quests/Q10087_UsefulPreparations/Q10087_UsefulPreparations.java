 ...
 */
package quests.Q10087_UsefulPreparations;
 ...
 * @author Magik
 */
public class Q10087_UsefulPreparations extends Quest
{
	private static final int QUEST_ID = 10087;
	...
	public Q10087_UsefulPreparations()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
		...
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				if (questState.isCond(QuestCondType.DONE) && !questState.isCompleted())
				{
					...
					final QuestState nextQuestState = player.getQuestState(Q10088_TimeToThinkAboutWeapons.class.getSimpleName());
					if (nextQuestState == null)
					{
						player.sendPacket(new ExQuestDialog(10088, QuestDialogType.ACCEPT));
					}
				}
				break;
			}
