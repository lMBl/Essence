 ...
 */
package quests.Q10015_LearningAutoHunt;
 ...
 * @author Magik
 */
public class Q10015_LearningAutoHunt extends Quest
{
	...
	public Q10015_LearningAutoHunt()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
		...
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				if (questState.isCond(QuestCondType.DONE) && !questState.isCompleted())
				{
					...
					final QuestState nextQuestState = player.getQuestState(Q10016_BePrepared.class.getSimpleName());
