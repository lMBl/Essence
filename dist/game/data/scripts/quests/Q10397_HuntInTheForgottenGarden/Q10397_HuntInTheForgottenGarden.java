 ...
 */
package quests.Q10397_HuntInTheForgottenGarden;
 ...
 * @author nnlyy520
 */
public class Q10397_HuntInTheForgottenGarden extends Quest
{
	private static final int QUEST_ID = 10397;
	private static final int[] MONSTERS =
	{
		22519, // Delh Lizardman
		22520, // Delh Lizardman Rogue
		22521, // Delh Lizardman Soldier
		22522, // Delh Lizardman Wizard
		22523, // Delh Giant
		22524, // Garden Priest
		22525, // Garden Archer
		22526, // Garden Patrol
		22527, // Garden Guard Captain
		22528, // Garden Apostle
	};
	
	public Q10397_HuntInTheForgottenGarden()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10398_HuntInTheTowerOfInsolence.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10398, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
