 ...
 */
package quests.Q10325_PayRespectToFallenBrethren4;
 ...
 * @author Magik
 */
public class Q10325_PayRespectToFallenBrethren4 extends Quest
{
	...
	public Q10325_PayRespectToFallenBrethren4()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10326_MemoryOfTheGloriousPast1.class.getSimpleName());
