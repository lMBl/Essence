 ...
 */
package quests.Q10120_UsefulPreparations;
 ...
 * @author Magik
 */
public class Q10120_UsefulPreparations extends Quest
{
	...
	public Q10120_UsefulPreparations()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
		...
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				if (questState.isCond(QuestCondType.DONE) && !questState.isCompleted())
				{
					...
					final QuestState nextQuestState = player.getQuestState(Q10121_TimeToThinkAboutWeapons.class.getSimpleName());
