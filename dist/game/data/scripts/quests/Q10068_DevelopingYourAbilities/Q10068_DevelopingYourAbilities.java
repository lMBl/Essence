 ...
 */
package quests.Q10068_DevelopingYourAbilities;
 ...
 * @author Magik
 */
public class Q10068_DevelopingYourAbilities extends Quest
{
	private static final int QUEST_ID = 10068;
	...
	public Q10068_DevelopingYourAbilities()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10069_TimeToChangeClass.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10069, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
