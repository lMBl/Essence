 ...
 */
package quests.Q10063_LearningAutoHunt;
 ...
 * @author Magik
 */
public class Q10063_LearningAutoHunt extends Quest
{
	private static final int QUEST_ID = 10063;
	...
	public Q10063_LearningAutoHunt()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
		...
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				if (questState.isCond(QuestCondType.DONE) && !questState.isCompleted())
				{
					...
					final QuestState nextQuestState = player.getQuestState(Q10064_BePrepared.class.getSimpleName());
					if (nextQuestState == null)
					{
						player.sendPacket(new ExQuestDialog(10064, QuestDialogType.ACCEPT));
					}
				}
				break;
			}
