 ...
 */
package quests.Q10074_LearningAutoHunt;
 ...
 * @author Magik
 */
public class Q10074_LearningAutoHunt extends Quest
{
	private static final int QUEST_ID = 10074;
	...
	public Q10074_LearningAutoHunt()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
		...
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				if (questState.isCond(QuestCondType.DONE) && !questState.isCompleted())
				{
					...
					final QuestState nextQuestState = player.getQuestState(Q10075_BePrepared.class.getSimpleName());
					if (nextQuestState == null)
					{
						player.sendPacket(new ExQuestDialog(10075, QuestDialogType.ACCEPT));
					}
				}
				break;
			}
