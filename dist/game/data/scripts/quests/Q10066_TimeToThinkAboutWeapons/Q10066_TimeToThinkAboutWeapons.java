 ...
 */
package quests.Q10066_TimeToThinkAboutWeapons;
 ...
 * @author Magik
 */
public class Q10066_TimeToThinkAboutWeapons extends Quest
{
	private static final int QUEST_ID = 10066;
	...
	public Q10066_TimeToThinkAboutWeapons()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10067_WatchOut.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10067, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
