 ...
 */
package quests.Q10412_RumorsAboutGorde2;
 ...
 * @author nnlyy520
 */
public class Q10412_RumorsAboutGorde2 extends Quest
{
	private static final int QUEST_ID = 10412;
	...
	public Q10412_RumorsAboutGorde2()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10413_RumorsAboutGorde3.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10413, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
