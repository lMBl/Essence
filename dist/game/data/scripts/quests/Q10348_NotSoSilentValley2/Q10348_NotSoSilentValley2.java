 ...
 */
package quests.Q10348_NotSoSilentValley2;
 ...
 * @author Magik
 */
public class Q10348_NotSoSilentValley2 extends Quest
{
	private static final int QUEST_ID = 10348;
	...
	public Q10348_NotSoSilentValley2()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10349_NotSoSilentValley3.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10349, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
