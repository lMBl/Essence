 ...
 */
package quests.Q10030_UsefulPreparations;
 ...
 * @author Magik
 */
public class Q10030_UsefulPreparations extends Quest
{
		...
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				if (questState.isCond(QuestCondType.DONE) && !questState.isCompleted())
				{
					...
					final QuestState nextQuestState = player.getQuestState(Q10031_TimeToThinkAboutWeapons.class.getSimpleName());
