 ...
 */
package quests.Q10121_TimeToThinkAboutWeapons;
 ...
 * @author Magik
 */
public class Q10121_TimeToThinkAboutWeapons extends Quest
{
	...
	public Q10121_TimeToThinkAboutWeapons()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10122_WatchOut.class.getSimpleName());
