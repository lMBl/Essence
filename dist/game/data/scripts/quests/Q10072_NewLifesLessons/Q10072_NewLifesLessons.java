 ...
 */
package quests.Q10072_NewLifesLessons;
 ...
 * @author Magik
 */
public class Q10072_NewLifesLessons extends Quest
{
	private static final int QUEST_ID = 10072;
		...
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				if (questState.isCond(QuestCondType.DONE) && !questState.isCompleted())
				{
					...
					final QuestState nextQuestState = player.getQuestState(Q10073_StrengthOfSpirit.class.getSimpleName());
					if (nextQuestState == null)
					{
						player.sendPacket(new ExQuestDialog(10073, QuestDialogType.ACCEPT));
					}
				}
				break;
			}
