 ...
 */
package quests.Q10355_StopTheLizardmen4;
 ...
 * @author Magik
 */
public class Q10355_StopTheLizardmen4 extends Quest
{
	private static final int QUEST_ID = 10355;
	...
	public Q10355_StopTheLizardmen4()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10356_StopTheLizardmen5.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10356, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
