 ...
 */
package quests.Q10095_StrengthOfSpirit;
 ...
 * @author Magik
 */
public class Q10095_StrengthOfSpirit extends Quest
{
	private static final int QUEST_ID = 10095;
	private static final int[] MONSTERS =
	{
		22183 // Training dummy
	};
	
	public Q10095_StrengthOfSpirit()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
		...
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				if (questState.isCond(QuestCondType.DONE) && !questState.isCompleted())
				{
					...
					final QuestState nextQuestState = player.getQuestState(Q10096_LearningAutoHunt.class.getSimpleName());
					if (nextQuestState == null)
					{
						player.sendPacket(new ExQuestDialog(10096, QuestDialogType.ACCEPT));
					}
				}
				break;
			}
