 ...
 */
package quests.Q10093_TheLifeOfADeathKnight;
 ...
 * @author Magik
 */
public class Q10093_TheLifeOfADeathKnight extends Quest
{
	private static final int QUEST_ID = 10093;
	
	public Q10093_TheLifeOfADeathKnight()
	{
		super(QUEST_ID);
	}
		...
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				if (questState.isCond(QuestCondType.DONE) && !questState.isCompleted())
				{
					...
					final QuestState nextQuestState = player.getQuestState(Q10094_NewLifesLessons.class.getSimpleName());
					if (nextQuestState == null)
					{
						player.sendPacket(new ExQuestDialog(10094, QuestDialogType.ACCEPT));
					}
				}
				break;
			}
	...
	public void onPlayerLogin(OnPlayerLogin event)
	{
		...
		if ((questState == null) || !questState.isCompleted())
		{
			player.sendPacket(new PlaySound(2, "tutorial_voice_054a", 0, 0, player.getX(), player.getY(), player.getZ()));
		}
	}
}
