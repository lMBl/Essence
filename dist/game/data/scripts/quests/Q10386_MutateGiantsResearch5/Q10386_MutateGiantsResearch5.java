 ...
 */
package quests.Q10386_MutateGiantsResearch5;
 ...
 * @author nnlyy520
 */
public class Q10386_MutateGiantsResearch5 extends Quest
{
	private static final int QUEST_ID = 10386;
	private static final int[] MONSTERS =
	{
		22369, // Giant Mercenary
		22370, // Mutated Warrior
		22371, // Mutated Tracker
		22372, // Mutated Archer
	};
	
	public Q10386_MutateGiantsResearch5()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10387_ProtectHotSpringsNepenthes1.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10387, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
