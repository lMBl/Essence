 ...
 */
package quests.Q10067_WatchOut;
 ...
 * @author Magik
 */
public class Q10067_WatchOut extends Quest
{
	private static final int QUEST_ID = 10067;
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10068_DevelopingYourAbilities.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10068, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
