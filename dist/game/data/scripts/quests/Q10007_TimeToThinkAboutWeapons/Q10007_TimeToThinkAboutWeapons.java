 ...
 */
package quests.Q10007_TimeToThinkAboutWeapons;
 ...
 * @author Magik, Mobius
 */
public class Q10007_TimeToThinkAboutWeapons extends Quest
{
	...
	public Q10007_TimeToThinkAboutWeapons()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10008_WatchOut.class.getSimpleName());
