 ...
 */
package quests.Q10405_ExploringTheBlazingSwamp;
 ...
 * @author nnlyy520
 */
public class Q10405_ExploringTheBlazingSwamp extends Quest
{
	private static final int QUEST_ID = 10405;
	private static final int[] MONSTERS =
	{
		22688, // Conjurer Bat
		22689, // Hames Orc Foot Soldier
		22690, // Hames Orc Prefect
	};
	
	public Q10405_ExploringTheBlazingSwamp()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10406_InvadersOfTheIvoryTowerCrater.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10406, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
