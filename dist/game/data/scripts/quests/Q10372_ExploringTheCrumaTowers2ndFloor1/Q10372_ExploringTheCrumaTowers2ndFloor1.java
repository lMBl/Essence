 ...
 */
package quests.Q10372_ExploringTheCrumaTowers2ndFloor1;
 ...
 * @author Magik
 */
public class Q10372_ExploringTheCrumaTowers2ndFloor1 extends Quest
{
	private static final int QUEST_ID = 10372;
	...
	public Q10372_ExploringTheCrumaTowers2ndFloor1()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10373_ExploringTheCrumaTowers2ndFloor2.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10373, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
