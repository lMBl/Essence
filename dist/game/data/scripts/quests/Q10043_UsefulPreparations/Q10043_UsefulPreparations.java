 ...
 */
package quests.Q10043_UsefulPreparations;
 ...
 * @author Magik
 */
public class Q10043_UsefulPreparations extends Quest
{
	private static final int QUEST_ID = 10043;
	...
	public Q10043_UsefulPreparations()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
		...
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				if (questState.isCond(QuestCondType.DONE) && !questState.isCompleted())
				{
					...
					final QuestState nextQuestState = player.getQuestState(Q10044_TimeToThinkAboutWeapons.class.getSimpleName());
					if (nextQuestState == null)
					{
						player.sendPacket(new ExQuestDialog(10044, QuestDialogType.ACCEPT));
					}
				}
				break;
			}
