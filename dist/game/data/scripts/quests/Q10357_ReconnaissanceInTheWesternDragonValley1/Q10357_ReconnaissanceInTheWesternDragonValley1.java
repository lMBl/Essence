 ...
 */
package quests.Q10357_ReconnaissanceInTheWesternDragonValley1;
 ...
 * @author Magik
 */
public class Q10357_ReconnaissanceInTheWesternDragonValley1 extends Quest
{
	private static final int QUEST_ID = 10357;
	...
	public Q10357_ReconnaissanceInTheWesternDragonValley1()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10358_ReconnaissanceInTheWesternDragonValley2.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10358, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
