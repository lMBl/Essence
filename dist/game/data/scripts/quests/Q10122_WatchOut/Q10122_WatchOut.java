 ...
 */
package quests.Q10122_WatchOut;
 ...
 * @author Magik
 */
public class Q10122_WatchOut extends Quest
{
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10123_DevelopingYourAbilities.class.getSimpleName());
