 ...
 */
package quests.Q10359_ReconnaissanceInTheWesternDragonValley3;
 ...
 * @author Magik
 */
public class Q10359_ReconnaissanceInTheWesternDragonValley3 extends Quest
{
	private static final int QUEST_ID = 10359;
	...
	public Q10359_ReconnaissanceInTheWesternDragonValley3()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10360_ReconnaissanceInTheWesternDragonValley4.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10360, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
