 ...
 */
package quests.Q10025_NewLifesLessons;
 ...
 * @author Magik
 */
public class Q10025_NewLifesLessons extends Quest
{
		...
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				if (questState.isCond(QuestCondType.DONE) && !questState.isCompleted())
				{
					...
					final QuestState nextQuestState = player.getQuestState(Q10027_StrengthOfSpirit.class.getSimpleName());
