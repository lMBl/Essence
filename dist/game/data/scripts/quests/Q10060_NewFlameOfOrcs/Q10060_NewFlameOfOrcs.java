 ...
 */
package quests.Q10060_NewFlameOfOrcs;
 ...
 * @author Magik
 */
public class Q10060_NewFlameOfOrcs extends Quest
{
	private static final int QUEST_ID = 10060;
	
	public Q10060_NewFlameOfOrcs()
	{
		super(QUEST_ID);
	}
	...
	public void onPlayerLogin(OnPlayerLogin event)
	{
		...
		if ((questState == null) || !questState.isCompleted())
		{
			player.sendPacket(new PlaySound(2, "tutorial_voice_064a", 0, 0, player.getX(), player.getY(), player.getZ()));
		}
	}
}
