 ...
 */
package quests.Q10305_SporeInfestedPlace;
 ...
 * @author Magik
 */
public class Q10305_SporeInfestedPlace extends Quest
{
	private static final int QUEST_ID = 10305;
	private static final int[] MONSTERS =
	{
		20176, // Earth Guardian Wyrm
		20555, // Giant Fungus
		20556, // Giant Monster Eye
		20557, // Dire Wyrm
		20558, // Rotting Tree
		20559, // Rotting Golem
		20560, // Spider Trisalim
		20561, // Trisalim Tarantula
		20562, // Spore Zombie
	};
	
	public Q10305_SporeInfestedPlace()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10306_PeaceInTheCemetery1.class.getSimpleName());
