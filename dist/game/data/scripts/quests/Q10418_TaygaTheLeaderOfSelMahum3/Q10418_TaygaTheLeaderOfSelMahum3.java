 ...
 */
package quests.Q10418_TaygaTheLeaderOfSelMahum3;
 ...
 * @author nnlyy520
 */
public class Q10418_TaygaTheLeaderOfSelMahum3 extends Quest
{
	private static final int QUEST_ID = 10418;
	private static final int[] MONSTERS =
	{
		22720 // Tayga Archer
	};
	
	public Q10418_TaygaTheLeaderOfSelMahum3()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10419_TaygaTheLeaderOfSelMahum4.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10419, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
