 ...
 */
package quests.Q10101_DevelopingYourAbilities;
 ...
 * @author Magik
 */
public class Q10101_DevelopingYourAbilities extends Quest
{
	...
	public Q10101_DevelopingYourAbilities()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10102_TimeToChangeClass.class.getSimpleName());
