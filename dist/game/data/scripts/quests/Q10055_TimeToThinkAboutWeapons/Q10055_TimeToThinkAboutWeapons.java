 ...
 */
package quests.Q10055_TimeToThinkAboutWeapons;
 ...
 * @author Magik
 */
public class Q10055_TimeToThinkAboutWeapons extends Quest
{
	private static final int QUEST_ID = 10055;
	...
	public Q10055_TimeToThinkAboutWeapons()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10056_WatchOut.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10056, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
