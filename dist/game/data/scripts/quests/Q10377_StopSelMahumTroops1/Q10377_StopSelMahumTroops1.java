 ...
 */
package quests.Q10377_StopSelMahumTroops1;
 ...
 * @author Magik
 */
public class Q10377_StopSelMahumTroops1 extends Quest
{
	private static final int QUEST_ID = 10377;
	private static final int[] MONSTERS =
	{
		22237 // Sel Mahum Sniper
	};
	
	public Q10377_StopSelMahumTroops1()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10378_StopSelMahumTroops2.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10378, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
