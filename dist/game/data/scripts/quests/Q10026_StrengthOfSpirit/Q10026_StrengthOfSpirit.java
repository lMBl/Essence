 ...
 */
package quests.Q10026_StrengthOfSpirit;
 ...
 * @author Magik
 */
public class Q10026_StrengthOfSpirit extends Quest
{
	...
	public Q10026_StrengthOfSpirit()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
		...
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				if (questState.isCond(QuestCondType.DONE) && !questState.isCompleted())
				{
					...
					final QuestState nextQuestState = player.getQuestState(Q10028_LearningAutoHunt.class.getSimpleName());
