 ...
 */
package quests.Q10009_DevelopingYourAbilities;
 ...
 * @author Magik
 */
public class Q10009_DevelopingYourAbilities extends Quest
{
	...
	public Q10009_DevelopingYourAbilities()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10010_TimeToChangeClass.class.getSimpleName());
