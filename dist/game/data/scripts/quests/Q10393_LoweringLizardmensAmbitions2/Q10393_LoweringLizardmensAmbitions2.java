 ...
 */
package quests.Q10393_LoweringLizardmensAmbitions2;
 ...
 * @author nnlyy520
 */
public class Q10393_LoweringLizardmensAmbitions2 extends Quest
{
	private static final int QUEST_ID = 10393;
	private static final int[] MONSTERS =
	{
		22707 // Melat Lizardman Warrior
	};
	
	public Q10393_LoweringLizardmensAmbitions2()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10394_LoweringLizardmensAmbitions3.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10394, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
