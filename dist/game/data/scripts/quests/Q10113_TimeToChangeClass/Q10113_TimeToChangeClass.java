 ...
 */
package quests.Q10113_TimeToChangeClass;
 ...
 * @author Magik
 */
public class Q10113_TimeToChangeClass extends Quest
{
	private static final int QUEST_ID = 10113;
	
	public Q10113_TimeToChangeClass()
	{
		super(QUEST_ID);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10114_WeSylphs.class.getSimpleName());
	...
	public void onPlayerProfessionChange(OnPlayerProfessionChange event)
	{
		...
		final QuestState questState = getQuestState(player, false);
		if ((questState != null) && !questState.isCompleted() && (player.getClassId().getId() > ClassId.SYLPH_GUNNER.getId()))
		{
