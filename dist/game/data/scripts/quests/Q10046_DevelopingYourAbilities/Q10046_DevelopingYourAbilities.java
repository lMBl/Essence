 ...
 * @author Magik
 */
public class Q10046_DevelopingYourAbilities extends Quest
{
	private static final int QUEST_ID = 10046;
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10047_TimeToChangeClass.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10047, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
