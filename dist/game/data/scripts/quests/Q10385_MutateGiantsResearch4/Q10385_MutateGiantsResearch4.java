 ...
 */
package quests.Q10385_MutateGiantsResearch4;
 ...
 * @author nnlyy520
 */
public class Q10385_MutateGiantsResearch4 extends Quest
{
	private static final int QUEST_ID = 10385;
	private static final int[] MONSTERS =
	{
		22372 // Mutated Archer
	};
	
	public Q10385_MutateGiantsResearch4()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				{
					player.sendPacket(new ExQuestDialog(10386, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
