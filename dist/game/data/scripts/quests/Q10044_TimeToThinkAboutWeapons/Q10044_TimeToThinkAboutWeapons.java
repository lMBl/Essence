 ...
 */
package quests.Q10044_TimeToThinkAboutWeapons;
 ...
 * @author Magik
 */
public class Q10044_TimeToThinkAboutWeapons extends Quest
{
	private static final int QUEST_ID = 10044;
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10045_WatchOut.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10045, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
