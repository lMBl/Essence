 ...
 */
package quests.Q10373_ExploringTheCrumaTowers2ndFloor2;
 ...
 * @author Magik
 */
public class Q10373_ExploringTheCrumaTowers2ndFloor2 extends Quest
{
	private static final int QUEST_ID = 10373;
	...
	public Q10373_ExploringTheCrumaTowers2ndFloor2()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10374_ExploringTheCrumaTowers2ndFloor3.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10374, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
