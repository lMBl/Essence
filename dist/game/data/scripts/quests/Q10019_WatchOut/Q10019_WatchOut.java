 ...
 */
package quests.Q10019_WatchOut;
 ...
 * @author Magik
 */
public class Q10019_WatchOut extends Quest
{
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10020_DevelopingYourAbilities.class.getSimpleName());
