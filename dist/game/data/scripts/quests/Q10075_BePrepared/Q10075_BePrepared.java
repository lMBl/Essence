 ...
 */
package quests.Q10075_BePrepared;
 ...
 * @author Magik
 */
public class Q10075_BePrepared extends Quest
{
	private static final int QUEST_ID = 10075;
		...
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				if (questState.isCond(QuestCondType.DONE) && !questState.isCompleted())
				{
					...
					final QuestState nextQuestState = player.getQuestState(Q10076_UsefulPreparations.class.getSimpleName());
					if (nextQuestState == null)
					{
						player.sendPacket(new ExQuestDialog(10076, QuestDialogType.ACCEPT));
					}
				}
				break;
			}
