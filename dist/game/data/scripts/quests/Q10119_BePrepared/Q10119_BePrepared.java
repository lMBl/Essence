 ...
 */
package quests.Q10119_BePrepared;
 ...
 * @author Magik
 */
public class Q10119_BePrepared extends Quest
{
		...
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				if (questState.isCond(QuestCondType.DONE) && !questState.isCompleted())
				{
					...
					final QuestState nextQuestState = player.getQuestState(Q10120_UsefulPreparations.class.getSimpleName());
