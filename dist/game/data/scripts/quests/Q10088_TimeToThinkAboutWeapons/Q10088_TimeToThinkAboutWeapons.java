 ...
 */
package quests.Q10088_TimeToThinkAboutWeapons;
 ...
 * @author Magik
 */
public class Q10088_TimeToThinkAboutWeapons extends Quest
{
	private static final int QUEST_ID = 10088;
	...
	public Q10088_TimeToThinkAboutWeapons()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10089_WatchOut.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10089, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
