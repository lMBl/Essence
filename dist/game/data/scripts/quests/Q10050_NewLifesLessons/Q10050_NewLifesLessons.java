 ...
 */
package quests.Q10050_NewLifesLessons;
 ...
 * @author Magik
 */
public class Q10050_NewLifesLessons extends Quest
{
	private static final int QUEST_ID = 10050;
	private static final int[] MONSTERS =
	{
		22183 // Training dummy
	};
	
	public Q10050_NewLifesLessons()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
		...
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				if (questState.isCond(QuestCondType.DONE) && !questState.isCompleted())
				{
					...
					final QuestState nextQuestState = player.getQuestState(Q10051_StrengthOfSpirit.class.getSimpleName());
					if (nextQuestState == null)
					{
						player.sendPacket(new ExQuestDialog(10051, QuestDialogType.ACCEPT));
					}
				}
				break;
			}
