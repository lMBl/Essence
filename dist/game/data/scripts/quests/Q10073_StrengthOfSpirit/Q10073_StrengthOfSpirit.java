 ...
 */
package quests.Q10073_StrengthOfSpirit;
 ...
 * @author Magik
 */
public class Q10073_StrengthOfSpirit extends Quest
{
	private static final int QUEST_ID = 10073;
		...
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				if (questState.isCond(QuestCondType.DONE) && !questState.isCompleted())
				{
					...
					final QuestState nextQuestState = player.getQuestState(Q10074_LearningAutoHunt.class.getSimpleName());
					if (nextQuestState == null)
					{
						player.sendPacket(new ExQuestDialog(10074, QuestDialogType.ACCEPT));
					}
				}
				break;
			}
