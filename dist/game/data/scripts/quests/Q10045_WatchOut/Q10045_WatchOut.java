 ...
 */
package quests.Q10045_WatchOut;
 ...
 * @author Magik
 */
public class Q10045_WatchOut extends Quest
{
	private static final int QUEST_ID = 10045;
	private static final int[] MONSTERS =
	{
		20015, // Marsh Zombie Elf
		20020, // Marsh Zombie Researcher
		20105, // Dark Horror
		20025, // Lesser Dark Horror
		20379 // Stone Giant Soldier
	};
	
	public Q10045_WatchOut()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10046_DevelopingYourAbilities.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10046, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
