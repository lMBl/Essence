 ...
 */
package quests.Q10094_NewLifesLessons;
 ...
 * @author Magik
 */
public class Q10094_NewLifesLessons extends Quest
{
	private static final int QUEST_ID = 10094;
	private static final int[] MONSTERS =
	{
		22183 // Training dummy
	};
	
	public Q10094_NewLifesLessons()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
		...
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				if (questState.isCond(QuestCondType.DONE) && !questState.isCompleted())
				{
					...
					final QuestState nextQuestState = player.getQuestState(Q10095_StrengthOfSpirit.class.getSimpleName());
					if (nextQuestState == null)
					{
						player.sendPacket(new ExQuestDialog(10095, QuestDialogType.ACCEPT));
					}
				}
				break;
			}
