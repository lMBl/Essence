 ...
 */
package quests.Q10013_FightingSkill;
 ...
 * @author Magik
 */
public class Q10013_FightingSkill extends Quest
{
		...
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				if (questState.isCond(QuestCondType.DONE) && !questState.isCompleted())
				{
					...
					final QuestState nextQuestState = player.getQuestState(Q10014_StrengthOfSpirit.class.getSimpleName());
