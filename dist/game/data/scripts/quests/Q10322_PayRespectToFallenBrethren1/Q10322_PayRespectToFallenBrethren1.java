 ...
 */
package quests.Q10322_PayRespectToFallenBrethren1;
 ...
 * @author Magik
 */
public class Q10322_PayRespectToFallenBrethren1 extends Quest
{
	private static final int QUEST_ID = 10322;
	private static final int[] MONSTERS =
	{
		20674, // Doom Knight
		21001, // Ache of Destruction
		21002, // Doom Scout
	...
	public Q10322_PayRespectToFallenBrethren1()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10323_PayRespectToFallenBrethren2.class.getSimpleName());
