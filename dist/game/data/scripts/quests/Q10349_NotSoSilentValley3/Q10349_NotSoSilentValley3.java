 ...
 */
package quests.Q10349_NotSoSilentValley3;
 ...
 * @author Magik
 */
public class Q10349_NotSoSilentValley3 extends Quest
{
	private static final int QUEST_ID = 10349;
	...
	public Q10349_NotSoSilentValley3()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10350_NotSoSilentValley4.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10350, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
