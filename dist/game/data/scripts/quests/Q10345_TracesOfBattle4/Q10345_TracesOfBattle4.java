 ...
 */
package quests.Q10345_TracesOfBattle4;
 ...
 * @author Magik
 */
public class Q10345_TracesOfBattle4 extends Quest
{
	private static final int QUEST_ID = 10345;
	private static final int[] MONSTERS =
	{
		20659, // GRAVEYARD_WANDERER
		20660, // ARCHER_OF_GREED
		20661, // HATAR_RATMAN_THIEF
		20662, // HATAR_RATMAN_BOSS
		20663, // HATAR_HANISHEE
		20664, // DEPRIVE
		20665, // TAIK_ORC_SUPPLY
		20667, // VIOLLENT_FARCRAN
		22103, // FIERCE_GUARD
	};
	
	public Q10345_TracesOfBattle4()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10346_TracesOfBattle5.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10346, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
