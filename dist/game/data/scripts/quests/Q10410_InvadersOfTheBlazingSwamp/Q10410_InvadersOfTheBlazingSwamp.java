 ...
 */
package quests.Q10410_InvadersOfTheBlazingSwamp;
 ...
 * @author nnlyy520
 */
public class Q10410_InvadersOfTheBlazingSwamp extends Quest
{
	private static final int QUEST_ID = 10410;
	private static final int[] MONSTERS =
	{
		22691 // Judge of Marsh
	};
	
	public Q10410_InvadersOfTheBlazingSwamp()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10411_RumorsAboutGorde1.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10411, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
