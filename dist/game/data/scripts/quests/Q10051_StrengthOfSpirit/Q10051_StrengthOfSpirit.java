 ...
 */
package quests.Q10051_StrengthOfSpirit;
 ...
 * @author Magik, jimi3
 */
public class Q10051_StrengthOfSpirit extends Quest
{
	private static final int QUEST_ID = 10051;
	private static final int[] MONSTERS =
	{
		22183 // Training dummy
	};
	
	public Q10051_StrengthOfSpirit()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
		...
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				if (questState.isCond(QuestCondType.DONE) && !questState.isCompleted())
				{
					...
					final QuestState nextQuestState = player.getQuestState(Q10052_LearningAutoHunt.class.getSimpleName());
					if (nextQuestState == null)
					{
						player.sendPacket(new ExQuestDialog(10052, QuestDialogType.ACCEPT));
					}
				}
				break;
			}
