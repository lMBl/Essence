 ...
 */
package quests.Q10367_ThwartingDragonsPlans1;
 ...
 * @author Magik
 */
public class Q10367_ThwartingDragonsPlans1 extends Quest
{
	private static final int QUEST_ID = 10367;
	...
	public Q10367_ThwartingDragonsPlans1()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10368_ThwartingDragonsPlans2.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10368, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
