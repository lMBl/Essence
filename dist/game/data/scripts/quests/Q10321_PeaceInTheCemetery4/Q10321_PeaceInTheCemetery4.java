 ...
 */
package quests.Q10321_PeaceInTheCemetery4;
 ...
 * @author Magik
 */
public class Q10321_PeaceInTheCemetery4 extends Quest
{
	...
	public Q10321_PeaceInTheCemetery4()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10322_PayRespectToFallenBrethren1.class.getSimpleName());
