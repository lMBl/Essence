 ...
 */
package quests.Q10016_BePrepared;
 ...
 * @author Magik
 */
public class Q10016_BePrepared extends Quest
{
		...
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				if (questState.isCond(QuestCondType.DONE) && !questState.isCompleted())
				{
					...
					final QuestState nextQuestState = player.getQuestState(Q10017_UsefulPreparations.class.getSimpleName());
