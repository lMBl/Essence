 ...
 */
package quests.Q10365_ExploringTheCrumaTowers3rdFloor4;
 ...
 * @author Magik
 */
public class Q10365_ExploringTheCrumaTowers3rdFloor4 extends Quest
{
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10366_ExploringTheCrumaTowers3rdFloor5.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10366, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
