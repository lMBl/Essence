 ...
 */
package quests.Q10396_LoweringLizardmensAmbitions5;
 ...
 * @author nnlyy520
 */
public class Q10396_LoweringLizardmensAmbitions5 extends Quest
{
	private static final int QUEST_ID = 10396;
	private static final int[] MONSTERS =
	{
		22710, // Melat Lizardman Berserker
		22711, // Melat Lizardman Berserker
	};
	
	public Q10396_LoweringLizardmensAmbitions5()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10397_HuntInTheForgottenGarden.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10397, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
