 ...
 */
package quests.Q10384_MutateGiantsResearch3;
 ...
 * @author nnlyy520
 */
public class Q10384_MutateGiantsResearch3 extends Quest
{
	private static final int QUEST_ID = 10384;
	private static final int[] MONSTERS =
	{
		22371 // Mutated Tracker
	};
	
	public Q10384_MutateGiantsResearch3()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10385_MutateGiantsResearch4.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10385, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
