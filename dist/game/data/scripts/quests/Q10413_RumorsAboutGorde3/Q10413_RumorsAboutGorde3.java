 ...
 */
package quests.Q10413_RumorsAboutGorde3;
 ...
 * @author nnlyy520
 */
public class Q10413_RumorsAboutGorde3 extends Quest
{
	private static final int QUEST_ID = 10413;
	...
	public Q10413_RumorsAboutGorde3()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10414_RumorsAboutGorde4.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10414, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
