 ...
 */
package quests.Q10106_StrengthOfSpirit;
 ...
 * @author Magik
 */
public class Q10106_StrengthOfSpirit extends Quest
{
	...
	public Q10106_StrengthOfSpirit()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
		...
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				if (questState.isCond(QuestCondType.DONE) && !questState.isCompleted())
				{
					...
					final QuestState nextQuestState = player.getQuestState(Q10107_LearningAutoHunt.class.getSimpleName());
					if (nextQuestState == null)
					{
						player.sendPacket(new ExQuestDialog(10107, QuestDialogType.ACCEPT));
					}
				}
				break;
			}
