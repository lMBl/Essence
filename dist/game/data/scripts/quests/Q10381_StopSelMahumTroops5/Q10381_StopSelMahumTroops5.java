 ...
 */
package quests.Q10381_StopSelMahumTroops5;
...
/**
 * @author Magik, nnlyy520
 */
public class Q10381_StopSelMahumTroops5 extends Quest
{
	private static final int QUEST_ID = 10381;
	private static final int[] MONSTERS =
	{
		22241 // Sel Mahum Thief
	};
	
	public Q10381_StopSelMahumTroops5()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10382_MutateGiantsResearch1.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10382, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
