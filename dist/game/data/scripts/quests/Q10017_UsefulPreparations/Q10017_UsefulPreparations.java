 ...
 */
package quests.Q10017_UsefulPreparations;
 ...
 * @author Magik
 */
public class Q10017_UsefulPreparations extends Quest
{
	...
	public Q10017_UsefulPreparations()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
		...
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				if (questState.isCond(QuestCondType.DONE) && !questState.isCompleted())
				{
					...
					final QuestState nextQuestState = player.getQuestState(Q10018_TimeToThinkAboutWeapons.class.getSimpleName());
