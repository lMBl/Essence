 ...
 */
package quests.Q10014_StrengthOfSpirit;
 ...
 * @author Magik
 */
public class Q10014_StrengthOfSpirit extends Quest
{
	...
	public Q10014_StrengthOfSpirit()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
		...
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				if (questState.isCond(QuestCondType.DONE) && !questState.isCompleted())
				{
					...
					final QuestState nextQuestState = player.getQuestState(Q10015_LearningAutoHunt.class.getSimpleName());
