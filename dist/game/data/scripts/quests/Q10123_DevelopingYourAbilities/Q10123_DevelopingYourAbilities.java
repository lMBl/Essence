 ...
 */
package quests.Q10123_DevelopingYourAbilities;
 ...
 * @author Magik
 */
public class Q10123_DevelopingYourAbilities extends Quest
{
	...
	public Q10123_DevelopingYourAbilities()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10124_TimeToChangeClass.class.getSimpleName());
