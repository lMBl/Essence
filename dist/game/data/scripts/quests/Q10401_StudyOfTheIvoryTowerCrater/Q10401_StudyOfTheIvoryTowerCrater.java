 ...
 */
package quests.Q10401_StudyOfTheIvoryTowerCrater;
 ...
 * @author nnlyy520
 */
public class Q10401_StudyOfTheIvoryTowerCrater extends Quest
{
	private static final int QUEST_ID = 10401;
	private static final int[] MONSTERS =
	{
		22684, // Manashen Gargoyle
		22685, // Reinforced Steel Golem
		22686, // Reinforced Monster Eye
		22687, // Reinforced Gargoyle
	};
	
	public Q10401_StudyOfTheIvoryTowerCrater()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10402_ExploringTheAncientBattleground.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10402, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
