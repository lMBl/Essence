 ...
 */
package quests.Q10390_ProtectHotSpringsNepenthes4;
 ...
 * @author nnlyy520
 */
public class Q10390_ProtectHotSpringsNepenthes4 extends Quest
{
	...
	public Q10390_ProtectHotSpringsNepenthes4()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10391_ProtectHotSpringsNepenthes5.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10391, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
