 ...
 */
package quests.Q10006_UsefulPreparations;
 ...
 * @author Magik, Mobius
 */
public class Q10006_UsefulPreparations extends Quest
{
	...
	public Q10006_UsefulPreparations()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
		...
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				if (questState.isCond(QuestCondType.DONE) && !questState.isCompleted())
				{
					...
					final QuestState nextQuestState = player.getQuestState(Q10007_TimeToThinkAboutWeapons.class.getSimpleName());
