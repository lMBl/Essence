 ...
 */
package quests.Q10100_WatchOut;
 ...
 * @author Magik
 */
public class Q10100_WatchOut extends Quest
{
	private static final int QUEST_ID = 10100;
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10101_DevelopingYourAbilities.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10101, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
