 ...
 */
package quests.Q10417_TaygaTheLeaderOfSelMahum2;
 ...
 * @author nnlyy520
 */
public class Q10417_TaygaTheLeaderOfSelMahum2 extends Quest
{
	private static final int QUEST_ID = 10417;
	private static final int[] MONSTERS =
	{
		22719 // Tayga Archer
	};
	
	public Q10417_TaygaTheLeaderOfSelMahum2()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10418_TaygaTheLeaderOfSelMahum3.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10418, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
