 ...
 */
package quests.Q10382_MutateGiantsResearch1;
 ...
 * @author nnlyy520
 */
public class Q10382_MutateGiantsResearch1 extends Quest
{
	private static final int QUEST_ID = 10382;
	private static final int[] MONSTERS =
	{
		22369 // Giant Mercenary
	};
	
	public Q10382_MutateGiantsResearch1()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10383_MutateGiantsResearch2.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10383, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
