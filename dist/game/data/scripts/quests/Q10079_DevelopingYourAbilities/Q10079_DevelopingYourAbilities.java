 ...
 */
package quests.Q10079_DevelopingYourAbilities;
 ...
 * @author Magik
 */
public class Q10079_DevelopingYourAbilities extends Quest
{
	private static final int QUEST_ID = 10079;
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10080_TimeToChangeClass.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10080, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
