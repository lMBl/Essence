 ...
 */
package quests.Q10080_TimeToChangeClass;
 ...
 * @author Magik
 */
public class Q10080_TimeToChangeClass extends Quest
{
	private static final int QUEST_ID = 10080;
	
	public Q10080_TimeToChangeClass()
	{
		super(QUEST_ID);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10081_BestMiner.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10081, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
	...
	public void onPlayerProfessionChange(OnPlayerProfessionChange event)
	{
		...
		final QuestState questState = getQuestState(player, false);
		if ((questState != null) && !questState.isCompleted() && (player.getClassId().getId() > ClassId.DWARVEN_FIGHTER.getId()))
		{
