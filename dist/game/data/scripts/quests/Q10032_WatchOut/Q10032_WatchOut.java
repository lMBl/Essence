 ...
 */
package quests.Q10032_WatchOut;
 ...
 * @author Magik
 */
public class Q10032_WatchOut extends Quest
{
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10033_DevelopingYourAbilities.class.getSimpleName());
