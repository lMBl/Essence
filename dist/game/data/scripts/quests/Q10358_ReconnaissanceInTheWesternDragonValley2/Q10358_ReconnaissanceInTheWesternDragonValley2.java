 ...
 */
package quests.Q10358_ReconnaissanceInTheWesternDragonValley2;
 ...
 * @author Magik
 */
public class Q10358_ReconnaissanceInTheWesternDragonValley2 extends Quest
{
	private static final int QUEST_ID = 10358;
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10359_ReconnaissanceInTheWesternDragonValley3.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10359, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
