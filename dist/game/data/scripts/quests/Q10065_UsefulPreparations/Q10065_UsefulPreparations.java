 ...
 */
package quests.Q10065_UsefulPreparations;
 ...
 * @author Magik
 */
public class Q10065_UsefulPreparations extends Quest
{
	private static final int QUEST_ID = 10065;
	...
	public Q10065_UsefulPreparations()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
		...
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				if (questState.isCond(QuestCondType.DONE) && !questState.isCompleted())
				{
					...
					final QuestState nextQuestState = player.getQuestState(Q10066_TimeToThinkAboutWeapons.class.getSimpleName());
					if (nextQuestState == null)
					{
						player.sendPacket(new ExQuestDialog(10066, QuestDialogType.ACCEPT));
					}
				}
				break;
			}
