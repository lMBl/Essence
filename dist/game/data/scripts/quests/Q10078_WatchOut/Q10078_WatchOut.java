 ...
 */
package quests.Q10078_WatchOut;
 ...
 * @author Magik
 */
public class Q10078_WatchOut extends Quest
{
	private static final int QUEST_ID = 10078;
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10079_DevelopingYourAbilities.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10079, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
