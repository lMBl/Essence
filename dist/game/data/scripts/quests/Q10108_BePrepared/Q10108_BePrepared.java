 ...
 */
package quests.Q10108_BePrepared;
 ...
 * @author Magik
 */
public class Q10108_BePrepared extends Quest
{
		...
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				if (questState.isCond(QuestCondType.DONE) && !questState.isCompleted())
				{
					...
					final QuestState nextQuestState = player.getQuestState(Q10109_UsefulPreparations.class.getSimpleName());
