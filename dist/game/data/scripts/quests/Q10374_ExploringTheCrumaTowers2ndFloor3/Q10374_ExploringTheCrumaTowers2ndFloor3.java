 ...
 */
package quests.Q10374_ExploringTheCrumaTowers2ndFloor3;
 ...
 * @author Magik
 */
public class Q10374_ExploringTheCrumaTowers2ndFloor3 extends Quest
{
	private static final int QUEST_ID = 10374;
	...
	public Q10374_ExploringTheCrumaTowers2ndFloor3()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10375_ExploringTheCrumaTowers2ndFloor4.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10375, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
