 ...
 */
package quests.Q10354_StopTheLizardmen3;
 ...
 * @author Magik
 */
public class Q10354_StopTheLizardmen3 extends Quest
{
	private static final int QUEST_ID = 10354;
	...
	public Q10354_StopTheLizardmen3()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10355_StopTheLizardmen4.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10355, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
