 ...
 */
package quests.Q10107_LearningAutoHunt;
 ...
 * @author Magik
 */
public class Q10107_LearningAutoHunt extends Quest
{
	...
	public Q10107_LearningAutoHunt()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
		...
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				if (questState.isCond(QuestCondType.DONE) && !questState.isCompleted())
				{
					...
					final QuestState nextQuestState = player.getQuestState(Q10108_BePrepared.class.getSimpleName());
