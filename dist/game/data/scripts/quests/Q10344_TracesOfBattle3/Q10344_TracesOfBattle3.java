 ...
 */
package quests.Q10344_TracesOfBattle3;
 ...
 * @author Magik
 */
public class Q10344_TracesOfBattle3 extends Quest
{
	private static final int QUEST_ID = 10344;
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10345_TracesOfBattle4.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10345, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
