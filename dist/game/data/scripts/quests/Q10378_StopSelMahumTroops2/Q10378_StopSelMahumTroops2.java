 ...
 */
package quests.Q10378_StopSelMahumTroops2;
 ...
 * @author Magik
 */
public class Q10378_StopSelMahumTroops2 extends Quest
{
	private static final int QUEST_ID = 10378;
	private static final int[] MONSTERS =
	{
		22238 // Sel Mahum Raider
	};
	
	public Q10378_StopSelMahumTroops2()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10379_StopSelMahumTroops3.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10379, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
