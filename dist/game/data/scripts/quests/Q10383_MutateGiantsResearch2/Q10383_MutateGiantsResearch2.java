 ...
 */
package quests.Q10383_MutateGiantsResearch2;
 ...
 * @author nnlyy520
 */
public class Q10383_MutateGiantsResearch2 extends Quest
{
	private static final int QUEST_ID = 10383;
	private static final int[] MONSTERS =
	{
		22370 // Mutated Warrior
	};
	
	public Q10383_MutateGiantsResearch2()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10384_MutateGiantsResearch3.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10384, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
