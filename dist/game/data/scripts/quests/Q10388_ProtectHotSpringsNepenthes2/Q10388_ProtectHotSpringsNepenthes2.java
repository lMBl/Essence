 ...
 */
package quests.Q10388_ProtectHotSpringsNepenthes2;
 ...
 * @author nnlyy520
 */
public class Q10388_ProtectHotSpringsNepenthes2 extends Quest
{
	private static final int QUEST_ID = 10388;
	private static final int[] MONSTERS =
	{
		22427 // Tailed Hunter
	};
	
	public Q10388_ProtectHotSpringsNepenthes2()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10389_ProtectHotSpringsNepenthes3.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10389, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
