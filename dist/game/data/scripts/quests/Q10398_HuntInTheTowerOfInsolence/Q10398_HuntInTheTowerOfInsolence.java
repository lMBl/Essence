 ...
 */
package quests.Q10398_HuntInTheTowerOfInsolence;
 ...
 * @author nnlyy520
 */
public class Q10398_HuntInTheTowerOfInsolence extends Quest
{
	private static final int QUEST_ID = 10398;
	//@formatter:off
	private static final int[] MONSTERS =
	{
		...
		22600,22601,22602,22603,22604,22605,22606,22607,22608,22609,
		22610,22611,22612,22613,
	};
	//@formatter:on
	
	public Q10398_HuntInTheTowerOfInsolence()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10399_PaganTempleAndKelbimsFortress.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10399, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
