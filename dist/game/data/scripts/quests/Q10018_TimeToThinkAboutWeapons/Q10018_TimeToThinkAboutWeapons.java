 ...
 */
package quests.Q10018_TimeToThinkAboutWeapons;
 ...
 * @author Magik
 */
public class Q10018_TimeToThinkAboutWeapons extends Quest
{
	...
	public Q10018_TimeToThinkAboutWeapons()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10019_WatchOut.class.getSimpleName());
