 ...
 * @author Magik
 */
public class Q10021_TimeToChangeClass extends Quest
{
	private static final int QUEST_ID = 10021;
	
	public Q10021_TimeToChangeClass()
	{
		super(QUEST_ID);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10022_GoingOut.class.getSimpleName());
