 ...
 */
package quests.Q10124_TimeToChangeClass;
 ...
 * @author Magik
 */
public class Q10124_TimeToChangeClass extends Quest
{
	private static final int QUEST_ID = 10124;
	
	public Q10124_TimeToChangeClass()
	{
		super(QUEST_ID);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10125_AssassinsFirstJob.class.getSimpleName());
	...
	public void onPlayerProfessionChange(OnPlayerProfessionChange event)
	{
		...
		final QuestState questState = getQuestState(player, false);
		if ((questState != null) && !questState.isCompleted() && (player.getClassId().getId() > ClassId.ASSASSIN_MALE_0.getId()))
		{
