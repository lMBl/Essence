 ...
 */
package quests.Q10347_NotSoSilentValley1;
 ...
 * @author Magik
 */
public class Q10347_NotSoSilentValley1 extends Quest
{
	private static final int QUEST_ID = 10347;
	...
	public Q10347_NotSoSilentValley1()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10348_NotSoSilentValley2.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10348, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
