 ...
 */
package quests.Q10406_InvadersOfTheIvoryTowerCrater;
 ...
 * @author nnlyy520
 */
public class Q10406_InvadersOfTheIvoryTowerCrater extends Quest
{
	private static final int QUEST_ID = 10406;
	private static final int[] MONSTERS =
	{
		22687 // Reinforced Gargoyle
	};
	
	public Q10406_InvadersOfTheIvoryTowerCrater()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10407_InvadersOfTheAncientBattleground.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10407, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
