 ...
 */
package quests.Q10408_InvadersOfTheEnchantedValley;
 ...
 * @author nnlyy520
 */
public class Q10408_InvadersOfTheEnchantedValley extends Quest
{
	private static final int QUEST_ID = 10408;
	private static final int[] MONSTERS =
	{
		22683 // Valley Treant
	};
	
	public Q10408_InvadersOfTheEnchantedValley()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10409_InvadersOfAnghelWaterfall.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10409, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
