 ...
 */
package quests.Q10031_TimeToThinkAboutWeapons;
 ...
 * @author Magik
 */
public class Q10031_TimeToThinkAboutWeapons extends Quest
{
	...
	public Q10031_TimeToThinkAboutWeapons()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10032_WatchOut.class.getSimpleName());
