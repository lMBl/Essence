 ...
 */
package quests.Q10389_ProtectHotSpringsNepenthes3;
 ...
 * @author nnlyy520
 */
public class Q10389_ProtectHotSpringsNepenthes3 extends Quest
{
	private static final int QUEST_ID = 10389;
	private static final int[] MONSTERS =
	{
		22428 // Tailed Berserker
	};
	
	public Q10389_ProtectHotSpringsNepenthes3()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10390_ProtectHotSpringsNepenthes4.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10390, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
