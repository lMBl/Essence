 ...
 */
package quests.Q10109_UsefulPreparations;
 ...
 * @author Magik
 */
public class Q10109_UsefulPreparations extends Quest
{
	...
	public Q10109_UsefulPreparations()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
		...
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				if (questState.isCond(QuestCondType.DONE) && !questState.isCompleted())
				{
					...
					final QuestState nextQuestState = player.getQuestState(Q10110_TimeToThinkAboutWeapons.class.getSimpleName());
