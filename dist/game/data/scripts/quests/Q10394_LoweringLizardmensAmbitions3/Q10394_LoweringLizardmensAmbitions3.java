 ...
 */
package quests.Q10394_LoweringLizardmensAmbitions3;
 ...
 * @author nnlyy520
 */
public class Q10394_LoweringLizardmensAmbitions3 extends Quest
{
	private static final int QUEST_ID = 10394;
	private static final int[] MONSTERS =
	{
		22708 // Melat Lizardman Shaman
	};
	
	public Q10394_LoweringLizardmensAmbitions3()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10395_LoweringLizardmensAmbitions4.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10395, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
