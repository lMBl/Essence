 ...
 */
package quests.Q10416_TaygaTheLeaderOfSelMahum1;
 ...
 * @author nnlyy520
 */
public class Q10416_TaygaTheLeaderOfSelMahum1 extends Quest
{
	private static final int QUEST_ID = 10416;
	private static final int[] MONSTERS =
	{
		22718 // Tayga Knight
	};
	
	public Q10416_TaygaTheLeaderOfSelMahum1()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10412_RumorsAboutGorde2.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10417, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
