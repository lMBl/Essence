 ...
 */
package quests.Q10090_DevelopingYourAbilities;
 ...
 * @author Magik
 */
public class Q10090_DevelopingYourAbilities extends Quest
{
	private static final int QUEST_ID = 10090;
	...
	public Q10090_DevelopingYourAbilities()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10091_TimeToChangeClass.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10091, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
