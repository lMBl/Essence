 ...
 */
package quests.Q10375_ExploringTheCrumaTowers2ndFloor4;
 ...
 * @author Magik
 */
public class Q10375_ExploringTheCrumaTowers2ndFloor4 extends Quest
{
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10376_ExploringTheCrumaTowers2ndFloor5.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10376, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
