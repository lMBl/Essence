 ...
 */
package quests.Q10342_TracesOfBattle1;
 ...
 * @author Magik
 */
public class Q10342_TracesOfBattle1 extends Quest
{
	private static final int QUEST_ID = 10342;
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10343_TracesOfBattle2.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10343, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
