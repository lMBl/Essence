 ...
 */
package quests.Q10399_PaganTempleAndKelbimsFortress;
 ...
 * @author nnlyy520
 */
public class Q10399_PaganTempleAndKelbimsFortress extends Quest
{
	private static final int QUEST_ID = 10399;
	private static final int[] MONSTERS =
	{
		22617, // Fortress Guard Captain
		22618, // Fortress Guard Captain
		22619, // Fortress Guard Captain
		22620, // Fortress Praetorian
		22621, // Fortress Praetorian
		22622, // Fortress Praetorian
		22623, // Fortress Praetorian
		22633, // Elite Fortress Guardian
		22634, // Elite Fortress Guardian
		22635, // Elite Fortress Guardian
		22636, // Elite Fortress Guardian
		22637, // Outer Castle's Guardian
		22638, // Outer Castle's Guardian
		22639, // Outer Castle's Guardian
		22640, // Outer Castle's Guardian
	};
	
	public Q10399_PaganTempleAndKelbimsFortress()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10400_InvitationToHellbound.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10400, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
