 ...
 */
package quests.Q10012_OutstandingMagesFirstSteps;
 ...
 * @author Magik
 */
public class Q10012_OutstandingMagesFirstSteps extends Quest
{
	private static final int QUEST_ID = 10012;
	
	public Q10012_OutstandingMagesFirstSteps()
	{
		super(QUEST_ID);
	}
		...
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				if (questState.isCond(QuestCondType.DONE) && !questState.isCompleted())
				{
					...
					final QuestState nextQuestState = player.getQuestState(Q10013_FightingSkill.class.getSimpleName());
	...
	public void onPlayerLogin(OnPlayerLogin event)
	{
		...
		if ((questState == null) || !questState.isCompleted())
		{
			player.sendPacket(new PlaySound(2, "tutorial_voice_001b_A", 0, 0, player.getX(), player.getY(), player.getZ()));
		}
	}
}
