 ...
 */
package quests.Q10091_TimeToChangeClass;
 ...
 * @author Magik
 */
public class Q10091_TimeToChangeClass extends Quest
{
	private static final int QUEST_ID = 10091;
	
	public Q10091_TimeToChangeClass()
	{
		super(QUEST_ID);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10092_NewHorizons.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10092, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
	...
	public void onPlayerProfessionChange(OnPlayerProfessionChange event)
	{
		...
		final QuestState questState = getQuestState(player, false);
		if ((questState != null) && !questState.isCompleted() && (player.getClassId().getId() > ClassId.KAMAEL_SOLDIER.getId()))
		{
