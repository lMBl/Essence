 ...
 */
package quests.Q10361_ReconnaissanceInTheWesternDragonValley5;
 ...
 * @author Magik
 */
public class Q10361_ReconnaissanceInTheWesternDragonValley5 extends Quest
{
	private static final int QUEST_ID = 10361;
	...
	public Q10361_ReconnaissanceInTheWesternDragonValley5()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10362_ExploringTheCrumaTowers3rdFloor1.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10362, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
