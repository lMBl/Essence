 ...
 */
package quests.Q10042_BePrepared;
 ...
 * @author Magik
 */
public class Q10042_BePrepared extends Quest
{
	private static final int QUEST_ID = 10042;
		...
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				if (questState.isCond(QuestCondType.DONE) && !questState.isCompleted())
				{
					...
					final QuestState nextQuestState = player.getQuestState(Q10043_UsefulPreparations.class.getSimpleName());
					if (nextQuestState == null)
					{
						player.sendPacket(new ExQuestDialog(10043, QuestDialogType.ACCEPT));
					}
				}
				break;
			}
