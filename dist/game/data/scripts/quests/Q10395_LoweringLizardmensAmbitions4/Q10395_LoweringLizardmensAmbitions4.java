 ...
 */
package quests.Q10395_LoweringLizardmensAmbitions4;
 ...
 * @author nnlyy520
 */
public class Q10395_LoweringLizardmensAmbitions4 extends Quest
{
	private static final int QUEST_ID = 10395;
	private static final int[] MONSTERS =
	{
		22709 // Melat Lizardman Sniper
	};
	
	public Q10395_LoweringLizardmensAmbitions4()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10386_MutateGiantsResearch5.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10396, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
