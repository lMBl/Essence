 ...
 */
package quests.Q10071_OreFromTheStripMine;
 ...
 * @author Magik
 */
public class Q10071_OreFromTheStripMine extends Quest
{
	private static final int QUEST_ID = 10071;
		...
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				if (questState.isCond(QuestCondType.DONE) && !questState.isCompleted())
				{
					...
					final QuestState nextQuestState = player.getQuestState(Q10072_NewLifesLessons.class.getSimpleName());
					if (nextQuestState == null)
					{
						player.sendPacket(new ExQuestDialog(10072, QuestDialogType.ACCEPT));
					}
				}
				break;
			}
	...
	public void onPlayerLogin(OnPlayerLogin event)
	{
		...
		if ((questState == null) || !questState.isCompleted())
		{
			player.sendPacket(new PlaySound(2, "tutorial_voice_001i_A", 0, 0, player.getX(), player.getY(), player.getZ()));
		}
	}
}
