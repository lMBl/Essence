 ...
 */
package quests.Q10102_TimeToChangeClass;
 ...
 * @author Magik
 */
public class Q10102_TimeToChangeClass extends Quest
{
	private static final int QUEST_ID = 10102;
	
	public Q10102_TimeToChangeClass()
	{
		super(QUEST_ID);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10103_ChallengingYourDestiny.class.getSimpleName());
	...
	public void onPlayerProfessionChange(OnPlayerProfessionChange event)
	{
		...
		final QuestState questState = getQuestState(player, false);
		if ((questState != null) && !questState.isCompleted() && (player.getClassId().getId() > ClassId.DEATH_PILGRIM_HUMAN.getId()))
		{
