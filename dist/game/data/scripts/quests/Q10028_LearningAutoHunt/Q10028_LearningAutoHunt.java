 ...
 */
package quests.Q10028_LearningAutoHunt;
 ...
 * @author Magik
 */
public class Q10028_LearningAutoHunt extends Quest
{
	...
	public Q10028_LearningAutoHunt()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
		...
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				if (questState.isCond(QuestCondType.DONE) && !questState.isCompleted())
				{
					...
					final QuestState nextQuestState = player.getQuestState(Q10029_BePrepared.class.getSimpleName());
