 ...
 */
package quests.Q10364_ExploringTheCrumaTowers3rdFloor3;
 ...
 * @author Magik
 */
public class Q10364_ExploringTheCrumaTowers3rdFloor3 extends Quest
{
	private static final int QUEST_ID = 10364;
	...
	public Q10364_ExploringTheCrumaTowers3rdFloor3()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10365_ExploringTheCrumaTowers3rdFloor4.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10365, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
