 ...
 */
package quests.Q10379_StopSelMahumTroops3;
 ...
 * @author Magik
 */
public class Q10379_StopSelMahumTroops3 extends Quest
{
	private static final int QUEST_ID = 10379;
	private static final int[] MONSTERS =
	{
		22239 // Sel Mahum Berserker
	};
	
	public Q10379_StopSelMahumTroops3()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10380_StopSelMahumTroops4.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10380, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
