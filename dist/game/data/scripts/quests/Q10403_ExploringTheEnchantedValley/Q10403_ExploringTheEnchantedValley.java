 ...
 */
package quests.Q10403_ExploringTheEnchantedValley;
 ...
 * @author nnlyy520
 */
public class Q10403_ExploringTheEnchantedValley extends Quest
{
	private static final int QUEST_ID = 10403;
	...
	public Q10403_ExploringTheEnchantedValley()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10404_ExploringAnghelWaterfall.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10404, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
