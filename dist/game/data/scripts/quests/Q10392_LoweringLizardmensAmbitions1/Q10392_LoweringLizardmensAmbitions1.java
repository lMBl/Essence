 ...
 */
package quests.Q10392_LoweringLizardmensAmbitions1;
 ...
 * @author nnlyy520
 */
public class Q10392_LoweringLizardmensAmbitions1 extends Quest
{
	private static final int QUEST_ID = 10392;
	private static final int[] MONSTERS =
	{
		22706 // Melat Lizardman
	};
	
	public Q10392_LoweringLizardmensAmbitions1()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10393_LoweringLizardmensAmbitions2.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10393, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
