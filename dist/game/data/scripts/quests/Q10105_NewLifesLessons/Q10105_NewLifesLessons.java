 ...
 */
package quests.Q10105_NewLifesLessons;
 ...
 * @author Magik, jimi3
 */
public class Q10105_NewLifesLessons extends Quest
{
		...
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				if (questState.isCond(QuestCondType.DONE) && !questState.isCompleted())
				{
					...
					final QuestState nextQuestState = player.getQuestState(Q10106_StrengthOfSpirit.class.getSimpleName());
