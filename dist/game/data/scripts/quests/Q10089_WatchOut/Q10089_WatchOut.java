 ...
 */
package quests.Q10089_WatchOut;
 ...
 * @author Magik
 */
public class Q10089_WatchOut extends Quest
{
	private static final int QUEST_ID = 10089;
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10090_DevelopingYourAbilities.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10090, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
