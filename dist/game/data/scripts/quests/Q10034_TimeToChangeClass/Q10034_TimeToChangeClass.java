 ...
 */
package quests.Q10034_TimeToChangeClass;
 ...
 * @author Magik
 */
public class Q10034_TimeToChangeClass extends Quest
{
	private static final int QUEST_ID = 10034;
	
	public Q10034_TimeToChangeClass()
	{
		super(QUEST_ID);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10035_WanderersPath.class.getSimpleName());
	...
	public void onPlayerProfessionChange(OnPlayerProfessionChange event)
	{
		...
		final QuestState questState = getQuestState(player, false);
		if ((questState != null) && ((!questState.isCompleted() && (player.getClassId().getId() > ClassId.ELVEN_FIGHTER.getId())) || (player.getClassId().getId() > ClassId.ELVEN_MAGE.getId())))
		{
