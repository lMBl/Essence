 ...
 */
package quests.Q10116_NewLifesLessons;
 ...
 * @author Magik
 */
public class Q10116_NewLifesLessons extends Quest
{
		...
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				if (questState.isCond(QuestCondType.DONE) && !questState.isCompleted())
				{
					...
					final QuestState nextQuestState = player.getQuestState(Q10117_StrengthOfSpirit.class.getSimpleName());
