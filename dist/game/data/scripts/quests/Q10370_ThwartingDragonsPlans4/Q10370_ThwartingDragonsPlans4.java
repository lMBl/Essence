 ...
 */
package quests.Q10370_ThwartingDragonsPlans4;
 ...
 * @author Magik
 */
public class Q10370_ThwartingDragonsPlans4 extends Quest
{
	private static final int QUEST_ID = 10370;
	...
	public Q10370_ThwartingDragonsPlans4()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10371_ThwartingDragonsPlans5.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10371, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
