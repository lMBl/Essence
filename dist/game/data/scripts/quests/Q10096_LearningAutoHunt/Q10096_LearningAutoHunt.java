 ...
 */
package quests.Q10096_LearningAutoHunt;
 ...
 * @author Magik
 */
public class Q10096_LearningAutoHunt extends Quest
{
	private static final int QUEST_ID = 10096;
	...
	public Q10096_LearningAutoHunt()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
		...
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				if (questState.isCond(QuestCondType.DONE) && !questState.isCompleted())
				{
					...
					final QuestState nextQuestState = player.getQuestState(Q10097_BePrepared.class.getSimpleName());
					if (nextQuestState == null)
					{
						player.sendPacket(new ExQuestDialog(10097, QuestDialogType.ACCEPT));
					}
				}
				break;
			}
