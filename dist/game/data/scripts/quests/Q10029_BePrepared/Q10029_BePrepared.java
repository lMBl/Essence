 ...
 */
package quests.Q10029_BePrepared;
 ...
 * @author Magik
 */
public class Q10029_BePrepared extends Quest
{
		...
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				if (questState.isCond(QuestCondType.DONE) && !questState.isCompleted())
				{
					...
					final QuestState nextQuestState = player.getQuestState(Q10030_UsefulPreparations.class.getSimpleName());
