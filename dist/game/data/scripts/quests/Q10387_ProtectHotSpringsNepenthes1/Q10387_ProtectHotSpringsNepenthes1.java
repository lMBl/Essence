 ...
 */
package quests.Q10387_ProtectHotSpringsNepenthes1;
 ...
 * @author nnlyy520
 */
public class Q10387_ProtectHotSpringsNepenthes1 extends Quest
{
	private static final int QUEST_ID = 10387;
	private static final int[] MONSTERS =
	{
		22426 // Tailed Warrior
	};
	
	public Q10387_ProtectHotSpringsNepenthes1()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10388_ProtectHotSpringsNepenthes2.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10388, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
