 ...
 */
package quests.Q10404_ExploringAnghelWaterfall;
 ...
 * @author nnlyy520
 */
public class Q10404_ExploringAnghelWaterfall extends Quest
{
	private static final int QUEST_ID = 10404;
	private static final int[] MONSTERS =
	{
		22672, // Harit Lizardman
		22673, // Harit Lizardman Warrior
		22674, // Harit Lizardman Archer
	};
	
	public Q10404_ExploringAnghelWaterfall()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10405_ExploringTheBlazingSwamp.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10405, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
