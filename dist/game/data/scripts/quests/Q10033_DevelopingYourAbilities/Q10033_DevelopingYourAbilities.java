 ...
 * @author Magik
 */
public class Q10033_DevelopingYourAbilities extends Quest
{
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10034_TimeToChangeClass.class.getSimpleName());
