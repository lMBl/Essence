 ...
 */
package quests.Q10368_ThwartingDragonsPlans2;
 ...
 * @author Magik
 */
public class Q10368_ThwartingDragonsPlans2 extends Quest
{
	private static final int QUEST_ID = 10368;
	...
	public Q10368_ThwartingDragonsPlans2()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10369_ThwartingDragonsPlans3.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10369, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
