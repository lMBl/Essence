 ...
 */
package quests.Q10008_WatchOut;
 ...
 * @author Magik
 */
public class Q10008_WatchOut extends Quest
{
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10009_DevelopingYourAbilities.class.getSimpleName());
