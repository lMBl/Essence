 ...
 */
package quests.Q10097_BePrepared;
 ...
 * @author Magik
 */
public class Q10097_BePrepared extends Quest
{
	private static final int QUEST_ID = 10097;
		...
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				if (questState.isCond(QuestCondType.DONE) && !questState.isCompleted())
				{
					...
					final QuestState nextQuestState = player.getQuestState(Q10098_UsefulPreparations.class.getSimpleName());
					if (nextQuestState == null)
					{
						player.sendPacket(new ExQuestDialog(10098, QuestDialogType.ACCEPT));
					}
				}
				break;
			}
