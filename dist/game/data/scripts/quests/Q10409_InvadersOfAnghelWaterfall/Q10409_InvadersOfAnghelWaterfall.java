 ...
 */
package quests.Q10409_InvadersOfAnghelWaterfall;
 ...
 * @author nnlyy520
 */
public class Q10409_InvadersOfAnghelWaterfall extends Quest
{
	private static final int QUEST_ID = 10409;
	private static final int[] MONSTERS =
	{
		22675 // Harit Lizardman Matriarch
	};
	
	public Q10409_InvadersOfAnghelWaterfall()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10410_InvadersOfTheBlazingSwamp.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10410, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
