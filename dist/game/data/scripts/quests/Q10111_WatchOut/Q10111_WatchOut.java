 ...
 */
package quests.Q10111_WatchOut;
 ...
 * @author Magik
 */
public class Q10111_WatchOut extends Quest
{
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10112_DevelopingYourAbilities.class.getSimpleName());
