 ...
 */
package quests.Q10057_DevelopingYourAbilities;
 ...
 * @author Magik, jimi3
 */
public class Q10057_DevelopingYourAbilities extends Quest
{
	private static final int QUEST_ID = 10057;
	...
	public Q10057_DevelopingYourAbilities()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q10058_TimeToChangeClass.class.getSimpleName());
				if (nextQuestState == null)
				{
					player.sendPacket(new ExQuestDialog(10058, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
