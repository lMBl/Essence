...
public class ExUserViewInfoParameter extends ServerPacket
{
	...
	public void writeImpl(GameClient client, WritableBuffer buffer)
	{
		...
		buffer.writeInt((int) _player.getStat().getValue(Stat.PHYSICAL_ATTACK, 0));
		...
		// M. Atk. (%)
		buffer.writeShort(index++);
		buffer.writeInt((int) _player.getStat().getValue(Stat.MAGIC_ATTACK, 0));
		...
		buffer.writeShort(index++);
		buffer.writeInt((int) _player.getStat().getValue(Stat.PVP_PHYSICAL_ATTACK_DAMAGE, 0));
		...
		// PvE Damage
		buffer.writeShort(index++);
		buffer.writeInt((int) _player.getStat().getValue(Stat.PVE_DAMAGE_TAKEN) * 100);
		...
		// P. Skill Power
		buffer.writeShort(index++);
		buffer.writeInt((int) _player.getStat().getValue(Stat.PHYSICAL_SKILL_POWER) * 100);
		
		// M. Skill Power
		buffer.writeShort(index++);
		buffer.writeInt((int) _player.getStat().getValue(Stat.MAGICAL_SKILL_POWER) * 100);
		
		// AoE Skill Damage
		buffer.writeShort(index++);
		buffer.writeInt((int) _player.getStat().getValue(Stat.AREA_OF_EFFECT_DAMAGE_MODIFY) * 100);
		
		// Damage Bonus - Sword
		buffer.writeShort(index++);
		buffer.writeInt(((_player.getActiveWeaponInstance() != null) && (_player.getActiveWeaponInstance().getItemType() == WeaponType.SWORD)) ? _player.getStat().getWeaponBonusPAtk() : 0);
		...
		buffer.writeShort(index++);
		buffer.writeInt((_player.getActiveWeaponInstance() != null) && (_player.getActiveWeaponInstance().getItemType() == WeaponType.ANCIENTSWORD) ? _player.getStat().getWeaponBonusPAtk() : 0);
		
		// Damage Bonus - Dagger
		buffer.writeShort(index++);
		buffer.writeInt((_player.getActiveWeaponInstance() != null) && (_player.getActiveWeaponInstance().getItemType() == WeaponType.DAGGER) ? _player.getStat().getWeaponBonusPAtk() : 0);
		
		// Damage Bonus - Rapier
		buffer.writeShort(index++);
		buffer.writeInt((_player.getActiveWeaponInstance() != null) && (_player.getActiveWeaponInstance().getItemType() == WeaponType.RAPIER) ? _player.getStat().getWeaponBonusPAtk() : 0);
		
		// Damage Bonus - Blunt Weapon (one hand)
		buffer.writeShort(index++);
		buffer.writeInt((_player.getActiveWeaponInstance() != null) && ((_player.getActiveWeaponInstance().getItemType() == WeaponType.ETC) || (_player.getActiveWeaponInstance().getItemType() == WeaponType.BLUNT) || (_player.getActiveWeaponInstance().getItemType() == WeaponType.DUALBLUNT)) ? _player.getStat().getWeaponBonusPAtk() : 0);
		...
		// Damage Bonus - Spear
		buffer.writeShort(index++);
		buffer.writeInt((_player.getActiveWeaponInstance() != null) && (_player.getActiveWeaponInstance().getItemType() == WeaponType.POLE) ? _player.getStat().getWeaponBonusPAtk() : 0);
		
		// Damage Bonus - Fists
		buffer.writeShort(index++);
		buffer.writeInt((_player.getActiveWeaponInstance() != null) && ((_player.getActiveWeaponInstance().getItemType() == WeaponType.FIST) || (_player.getActiveWeaponInstance().getItemType() == WeaponType.DUALFIST)) ? _player.getStat().getWeaponBonusPAtk() : 0);
		
		// Damage Bonus - Dual Swords
		buffer.writeShort(index++);
		buffer.writeInt((_player.getActiveWeaponInstance() != null) && (_player.getActiveWeaponInstance().getItemType() == WeaponType.DUAL) ? _player.getStat().getWeaponBonusPAtk() : 0);
		
		// Damage Bonus - Bow
		buffer.writeShort(index++);
		buffer.writeInt((_player.getActiveWeaponInstance() != null) && ((_player.getActiveWeaponInstance().getItemType() == WeaponType.BOW) || (_player.getActiveWeaponInstance().getItemType() == WeaponType.CROSSBOW) || (_player.getActiveWeaponInstance().getItemType() == WeaponType.TWOHANDCROSSBOW)) ? _player.getStat().getWeaponBonusPAtk() : 0);
		
		// Damage Bonus - Firearms
		buffer.writeShort(index++);
		buffer.writeInt((_player.getActiveWeaponInstance() != null) && (_player.getActiveWeaponInstance().getItemType() == WeaponType.PISTOLS) ? _player.getStat().getWeaponBonusPAtk() : 0);
		
		// ################################## DEFENCE ##############################
		// P. Def. (%)
		buffer.writeShort(index++);
		buffer.writeInt((int) _player.getStat().getValue(Stat.PHYSICAL_DEFENCE) * 100);
		...
		// M. Def. (%)
		buffer.writeShort(index++);
		buffer.writeInt((int) _player.getStat().getValue(Stat.MAGICAL_DEFENCE) * 100);
		...
		buffer.writeShort(index++);
		buffer.writeInt((int) (100 - (_player.getStat().getValue(Stat.SOULSHOT_RESISTANCE, 1) * 100)));
		
		// Spiritshot Damage Resistance
		buffer.writeShort(index++);
		buffer.writeInt((int) (100 - (_player.getStat().getValue(Stat.SPIRITSHOT_RESISTANCE, 1) * 100)));
		
		// Received basic PvP Damage
		buffer.writeShort(index++);
		buffer.writeInt((int) _player.getStat().getValue(Stat.PVP_PHYSICAL_ATTACK_DEFENCE) * 100);
		
		// Received P. Skill Damage in PvP
		buffer.writeShort(index++);
		buffer.writeInt((int) _player.getStat().getValue(Stat.PVP_PHYSICAL_SKILL_DEFENCE) * 100);
		
		// Received M. Skill Damage in PvP
		buffer.writeShort(index++);
		buffer.writeInt((int) _player.getStat().getValue(Stat.PVP_MAGICAL_SKILL_DEFENCE) * 100);
		...
		buffer.writeShort(index++);
		buffer.writeInt((int) _player.getStat().getValue(Stat.AREA_OF_EFFECT_DAMAGE_DEFENCE) * 100);
		
		// Damage Resistance Bonus - One hand Sword
		buffer.writeShort(index++);
		buffer.writeInt((int) _player.getStat().getDefenceTrait(TraitType.SWORD) * 100);
		...
		buffer.writeShort(index++);
		buffer.writeInt((int) _player.getStat().getDefenceTrait(TraitType.ANCIENTSWORD) * 100);
		
		// Damage Resistance Bonus - Dagger
		buffer.writeShort(index++);
		buffer.writeInt((int) _player.getStat().getDefenceTrait(TraitType.DAGGER) * 100);
		
		// Damage Resistance Bonus - Rapier
		buffer.writeShort(index++);
		buffer.writeInt((int) _player.getStat().getDefenceTrait(TraitType.RAPIER) * 100);
		
		// Damage Resistance Bonus - Blunt Weapon one hand
		buffer.writeShort(index++);
		buffer.writeInt((int) _player.getStat().getDefenceTrait(TraitType.BLUNT) * 100);
		...
		buffer.writeShort(index++);
		buffer.writeInt((int) _player.getStat().getDefenceTrait(TraitType.POLE) * 100);
		
		// Damage Resistance Bonus - Fists
		buffer.writeShort(index++);
		buffer.writeInt((int) _player.getStat().getDefenceTrait(TraitType.FIST) * 100);
		
		// Damage Resistance Bonus - Dual Swords
		buffer.writeShort(index++);
		buffer.writeInt((int) _player.getStat().getDefenceTrait(TraitType.DUAL) * 100);
		
		// Damage Resistance Bonus - Bow
		buffer.writeShort(index++);
		buffer.writeInt((int) _player.getStat().getDefenceTrait(TraitType.BOW) * 100);
		
		// Damage Resistance Bonus - Firearms
		buffer.writeShort(index++);
		buffer.writeInt((int) _player.getStat().getDefenceTrait(TraitType.PISTOLS) * 100);
		
		// Shield Defense (%)
		buffer.writeShort(index++);
		buffer.writeInt((int) _player.getStat().getValue(Stat.SHIELD_DEFENCE) * 100);
		...
		// M. Damage Resistance (%)
		buffer.writeShort(index++);
		buffer.writeInt((int) _player.getStat().getValue(Stat.ABNORMAL_RESIST_MAGICAL) * 100);
		...
		// M. Damage Reflection (%)
		buffer.writeShort(index++);
		buffer.writeInt((int) _player.getStat().getValue(Stat.REFLECT_DAMAGE_PERCENT) * 100);
		
		// M. Damage Reflection Resistance
		buffer.writeShort(index++);
		buffer.writeInt((int) _player.getStat().getValue(Stat.REFLECT_DAMAGE_PERCENT_DEFENSE) * 100);
		
		// Received Fixed Damage (%)
		buffer.writeShort(index++);
		buffer.writeInt((int) _player.getStat().getValue(Stat.REAL_DAMAGE_RESIST) * 100);
		
		// Casting Interruption Rate (%)
		buffer.writeShort(index++);
		buffer.writeInt((int) _player.getStat().getValue(Stat.ATTACK_CANCEL) * 100);
		...
		// P. Accuracy (%)
		buffer.writeShort(index++);
		buffer.writeInt((int) _player.getStat().getValue(Stat.ACCURACY_COMBAT) * 100);
		...
		// M. Accuracy (%)
		buffer.writeShort(index++);
		buffer.writeInt((int) _player.getStat().getValue(Stat.ACCURACY_MAGIC) * 100);
		...
		buffer.writeShort(index++);
		buffer.writeInt((int) _player.getStat().getValue(Stat.BLOW_RATE) * 100);
		...
		buffer.writeShort(index++);
		buffer.writeInt((int) _player.getStat().getValue(Stat.BLOW_RATE_DEFENCE) * 100);
		...
		// P. Skill Evasion (%)
		buffer.writeShort(index++);
		buffer.writeInt((int) _player.getStat().getValue(Stat.EVASION_RATE) * 100);
		
		// M. Skill Evasion (%)
		buffer.writeShort(index++);
		buffer.writeInt((int) _player.getStat().getValue(Stat.MAGIC_EVASION_RATE) * 100);
		...
		buffer.writeShort(index++);
		buffer.writeInt((int) _player.getStat().getValue(Stat.CRITICAL_RATE_SKILL) * 100);
		...
		buffer.writeShort(index++);
		buffer.writeInt((int) _player.getStat().getValue(Stat.MAGIC_CRITICAL_RATE) * 100);
		...
		buffer.writeShort(index++);
		buffer.writeInt((int) _player.getStat().getValue(Stat.CRITICAL_RATE) * 100);
		...
		buffer.writeShort(index++);
		buffer.writeInt((int) _player.getStat().getValue(Stat.DEFENCE_CRITICAL_RATE) * 100);
		
		// Received P. Skill Critical Rate (num.)
		buffer.writeShort(index++);
		buffer.writeInt((int) _player.getStat().getValue(Stat.DEFENCE_CRITICAL_RATE_ADD));
		
		// Received M. Skill Critical Rate (%)
		buffer.writeShort(index++);
		buffer.writeInt((int) _player.getStat().getValue(Stat.DEFENCE_MAGIC_CRITICAL_RATE) * 100);
		
		// Received M. Skill Critical Rate (num.)
		buffer.writeShort(index++);
		buffer.writeInt((int) _player.getStat().getValue(Stat.DEFENCE_MAGIC_CRITICAL_RATE_ADD));
		...
		buffer.writeShort(index++);
		buffer.writeInt((int) _player.getStat().getValue(Stat.PHYSICAL_SKILL_CRITICAL_DAMAGE) * 100);
		
		// P. Skill Critical Damage (num.)
		buffer.writeShort(index++);
		buffer.writeInt((int) _player.getStat().getValue(Stat.PHYSICAL_SKILL_CRITICAL_DAMAGE_ADD));
		
		// M. Skill Critical Damage (%)
		buffer.writeShort(index++);
		buffer.writeInt((int) _player.getStat().getValue(Stat.MAGIC_CRITICAL_DAMAGE) * 100);
		
		// M. Skill Critical Damage (num.)
		buffer.writeShort(index++);
		buffer.writeInt((int) _player.getStat().getValue(Stat.MAGIC_CRITICAL_DAMAGE_ADD));
		
		// Received Basic Critical Damage (%)
		buffer.writeShort(index++);
		buffer.writeInt((int) _player.getStat().getValue(Stat.DEFENCE_CRITICAL_DAMAGE) * 100);
		...
		buffer.writeShort(index++);
		buffer.writeInt((int) _player.getStat().getValue(Stat.DEFENCE_PHYSICAL_SKILL_CRITICAL_DAMAGE) * 100);
		
		// Received P. Skill Critical Damage (num.)
		buffer.writeShort(index++);
		buffer.writeInt((int) _player.getStat().getValue(Stat.DEFENCE_PHYSICAL_SKILL_CRITICAL_DAMAGE_ADD));
		
		// Received M. Skill Critical Damage (%)
		buffer.writeShort(index++);
		buffer.writeInt((int) _player.getStat().getValue(Stat.DEFENCE_MAGIC_CRITICAL_DAMAGE) * 100);
		
		// Received M. Skill Critical Damage (num.)
		buffer.writeShort(index++);
		buffer.writeInt((int) _player.getStat().getValue(Stat.DEFENCE_MAGIC_CRITICAL_DAMAGE_ADD));
		...
		// HP Recovery Rate (%)
		buffer.writeShort(index++);
		buffer.writeInt((int) _player.getStat().getValue(Stat.REGENERATE_HP_RATE) * 100);
		...
		// MP Recovery Rate (%)
		buffer.writeShort(index++);
		buffer.writeInt((int) _player.getStat().getValue(Stat.REGENERATE_MP_RATE) * 100);
		...
		// CP Recovery Rate (%)
		buffer.writeShort(index++);
		buffer.writeInt((int) _player.getStat().getValue(Stat.REGENERATE_CP_RATE) * 100);
		...
		buffer.writeShort(index++);
		buffer.writeInt((int) _player.getStat().getValue(Stat.RESIST_DISPEL_BUFF) * 100);
